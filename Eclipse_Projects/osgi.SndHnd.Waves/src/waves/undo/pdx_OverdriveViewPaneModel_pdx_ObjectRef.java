...
* From Input File : /Users/thorngreen/svngogl/ddt/trunk/osgi.SndHnd/src/labdaw/undo/OverdriveViewPaneModel.JUndo
**************/

package waves.undo;

public class pdx_OverdriveViewPaneModel_pdx_ObjectRef extends jundo.runtime.ExtObjectRef
	{
protected pdx_OverdriveViewPaneModel_pdx_ObjectRef( jundo.runtime.KeyRef Key )
{
super( Key );
}

public static waves.undo.pdx_OverdriveViewPaneModel_pdx_PairRef createOID_OverdriveViewPaneModel( jundo.runtime.ExtMilieuRef InMil )
{
...
pdx_OverdriveViewPaneModel_pdx_ObjectRef NewObj = 
	new pdx_OverdriveViewPaneModel_pdx_ObjectRef( MyKey );
waves.undo.pdx_OverdriveViewPaneModel_pdx_PairRef ret = new waves.undo.pdx_OverdriveViewPaneModel_pdx_PairRef( NewObj , NewMil );
return( ret );
}
	public static waves.undo.pdx_OverdriveViewPaneModel_pdx_PairRef pdxm_new_OverdriveViewPaneModel( final jundo.runtime.ExtMilieuRef pdx_thismilieu , final double  startParam , final double  endParam , final double  startLevel , final double  endLevel )
{
final waves.undo.pdx_OverdriveViewPaneModel_pdx_PairRef pdx_tmp_3162 = waves.undo.pdx_OverdriveViewPaneModel_pdx_ObjectRef.pdxm_allocate_OverdriveViewPaneModel( ( pdx_thismilieu ) );
final waves.undo.pdx_OverdriveViewPaneModel_pdx_ObjectRef pdx_tmp_3160 = (waves.undo.pdx_OverdriveViewPaneModel_pdx_ObjectRef)( pdx_tmp_3162.getObject() );
...
return( new waves.undo.pdx_OverdriveViewPaneModel_pdx_PairRef( pdx_tmp_3160 , ( pdx_tmp_3960 ) ) );
}
	public static waves.undo.pdx_OverdriveViewPaneModel_pdx_PairRef pdxm_allocate_OverdriveViewPaneModel( final jundo.runtime.ExtMilieuRef pdx_thismilieu )
{
final waves.undo.pdx_OverdriveViewPaneModel_pdx_PairRef t1 = pdx_OverdriveViewPaneModel_pdx_ObjectRef.createOID_OverdriveViewPaneModel( pdx_thismilieu );
final waves.undo.pdx_OverdriveViewPaneModel_pdx_PairRef t2 = pdx_zero( t1.getMilieu() , (waves.undo.pdx_OverdriveViewPaneModel_pdx_ObjectRef)( t1.getObject() ) );

return( t2 );
}
	public static waves.undo.pdx_OverdriveViewPaneModel_pdx_PairRef pdx_zero( final jundo.runtime.ExtMilieuRef pdx_thismilieu , final waves.undo.pdx_OverdriveViewPaneModel_pdx_ObjectRef in )
{
final waves.undo.pdx_OverdriveViewPaneModel_pdx_PairRef tx = new waves.undo.pdx_OverdriveViewPaneModel_pdx_PairRef( in , pdx_thismilieu );
...
final waves.undo.pdx_OverdriveViewPaneModel_pdx_PairRef z = new waves.undo.pdx_OverdriveViewPaneModel_pdx_PairRef( in , t4 );
return( z );
}
