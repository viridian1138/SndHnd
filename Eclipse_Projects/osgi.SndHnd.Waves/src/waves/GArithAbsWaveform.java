...
/**
 * 
 * A node representing a waveform taking the absolute value of an input waveform.
 * 
 * @author tgreen
 *
 */
public class GArithAbsWaveform extends GWaveForm  implements Externalizable {
	...
	public WaveForm genWave(HashMap s) {
		...
		ArithAbsWaveform wv = new ArithAbsWaveform( w );
		s.put(this, wv);
