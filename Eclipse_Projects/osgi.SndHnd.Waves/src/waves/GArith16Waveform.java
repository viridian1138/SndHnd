...
/**
 * 
 * A node representing a waveform taking an input waveform to the sixteenth power.
 * 
 * @author tgreen
 *
 */
public class GArith16Waveform extends GWaveForm  implements Externalizable {
	...
	public WaveForm genWave(HashMap s) {
		...
		Arith16Waveform wv = new Arith16Waveform( w );
		s.put(this, wv);
