...
/**
 * 
 * A node representing a waveform taking an input waveform to the twenty-fourth power.
 * 
 * @author tgreen
 *
 */
public class GArith24Waveform extends GWaveForm  implements Externalizable {
	...
	public WaveForm genWave(HashMap s) {
		...
		Arith24Waveform wv = new Arith24Waveform( w );
		s.put(this, wv);
