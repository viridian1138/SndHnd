...
/**
 * 
 * A node representing a waveform taking an input waveform to the twenty-second power.
 * 
 * @author tgreen
 *
 */
public class GArith22Waveform extends GWaveForm  implements Externalizable {
	...
	public WaveForm genWave(HashMap s) {
		...
		Arith22Waveform wv = new Arith22Waveform( w );
		s.put(this, wv);
