...
* @author Thorn Green
*/
public class MultiSincWaveFormEditor
	...
	*/
	 ...
	 */
	protected GMultiSincWaveForm waveForm = null;
	
	/**
	 * Text field for editing the relative frequency of the underlying sinc functions.
	 */
	...
	/**
	* Constructs the property editor for a given GMultiSincWaveForm.
	* @param in The input GMultiSincWaveForm.
	* @param _ins The associated instrument track.
	*/
	public MultiSincWaveFormEditor(GMultiSincWaveForm in , InstrumentTrack _ins) {
		waveForm = in;
		ins = _ins;
