...
/**
 * 
 * A node representing a waveform taking an input waveform to the eighteenth power.
 * 
 * @author tgreen
 *
 */
public class GArith18Waveform extends GWaveForm  implements Externalizable {
	...
	public WaveForm genWave(HashMap s) {
		...
		Arith18Waveform wv = new Arith18Waveform( w );
		s.put(this, wv);
