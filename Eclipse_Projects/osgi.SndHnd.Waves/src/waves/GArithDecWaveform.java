...
/**
 * 
 * A node representing a waveform taking an input waveform to the tenth power.
 * 
 * @author tgreen
 *
 */
public class GArithDecWaveform extends GWaveForm  implements Externalizable {
	...
	public WaveForm genWave(HashMap s) {
		...
		ArithDecWaveform wv = new ArithDecWaveform( w );
		s.put(this, wv);
