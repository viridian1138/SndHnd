...
/**
* A property editor for editing a GArithGntWaveform node.
* <P>
* @author Thorn Green
*/
public class ArithGntWaveformEditor
	...
	*/
	 ...
	 * The input waveform.
	 */
	protected GArithGntWaveform waveForm = null;
	...
	/**
	* Constructs the property editor for a given GArithGntWaveform.
	* @param in The input GArithGntWaveform.
	* @param _ins The associated instrument track.
	*/
	public ArithGntWaveformEditor(GArithGntWaveform in , InstrumentTrack _ins) {
		waveForm = in;
		ins = _ins;
