...
/**
 * 
 * Node representing a waveform that takes an input waveform and an altering function w2,
 ...
 *
 */
public class GFrequencyLnWaveForm extends GWaveForm implements Externalizable {
	...
	public WaveForm genWave(HashMap s) {
		...
		FrequencyLnWaveForm wv = new FrequencyLnWaveForm( a1 , a2 );
		s.put(this, wv);
