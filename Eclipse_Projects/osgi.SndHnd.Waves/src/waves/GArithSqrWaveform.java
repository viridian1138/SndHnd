...
/**
 * 
 * A node representing a waveform taking the square of an input waveform.
 * 
 * @author tgreen
 *
 */
public class GArithSqrWaveform extends GWaveForm  implements Externalizable {
	...
	public WaveForm genWave(HashMap s) {
		...
		ArithSqrWaveform wv = new ArithSqrWaveform( w );
		s.put(this, wv);
