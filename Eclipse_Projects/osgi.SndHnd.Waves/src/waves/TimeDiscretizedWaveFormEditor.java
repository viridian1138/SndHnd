...
/**
* A property editor for editing a GTimeDiscretizedWaveForm node.
* <P>
* @author Thorn Green
*/
public class TimeDiscretizedWaveFormEditor
	...
	*/
	 ...
	 */
	protected GTimeDiscretizedWaveForm waveForm = null;
	
	/**
	 * Text field for editing the number of discretizations in the wave period.
	 */
	...
	/**
	* Constructs the property editor for a given GTimeDiscretizedWaveForm.
	* @param in The input GTimeDiscretizedWaveForm.
	* @param _ins The associated instrument track.
	*/
	public TimeDiscretizedWaveFormEditor(GTimeDiscretizedWaveForm in , InstrumentTrack _ins) {
		waveForm = in;
		ins = _ins;
	...
	* the edited GTimeDiscretizedWaveForm.
	*/
