 ...
 *
 */
public class ArithCntWaveform extends WaveForm {
	 ...
	 */
	public ArithCntWaveform( WaveForm in , int _max )
	{
		wave = in;
		max = _max;
	}
	...
	public NonClampedCoefficient genClone() throws Throwable
	{
		...
		{
			return( new ArithCntWaveform( wv , max ) );
		}
	}
	...
	public GWaveForm genWave( HashMap s )
	{
		...
		GArithCntWaveform wv = new GArithCntWaveform();
		s.put(this, wv);
