...
/**
* A property editor for editing a GSincWaveform node.
* <P>
* @author Thorn Green
*/
public class SincWaveformEditor
	...
	*/
	 ...
	 */
	protected GSincWaveform waveForm = null;
	
	/**
	 * Text field for editing the height of the undefined region near x = 0.
	 */
	...
	/**
	* Constructs the property editor for a given GSincWaveform.
	* @param in The input GSincWaveform.
	* @param _ins The associated instrument track.
	*/
	public SincWaveformEditor(GSincWaveform in , InstrumentTrack _ins) {
		waveForm = in;
		ins = _ins;
