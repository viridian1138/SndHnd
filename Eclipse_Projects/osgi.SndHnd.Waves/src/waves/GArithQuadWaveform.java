...
/**
 * 
 * A node representing a waveform taking an input waveform to the fourth power.
 * 
 * @author tgreen
 *
 */
public class GArithQuadWaveform extends GWaveForm  implements Externalizable {
	...
	public WaveForm genWave(HashMap s) {
		...
		ArithQuadWaveform wv = new ArithQuadWaveform( w );
		s.put(this, wv);
