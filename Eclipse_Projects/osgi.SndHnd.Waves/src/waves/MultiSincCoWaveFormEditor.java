...
/**
* A property editor for editing a GMultiSincWaveForm node.
* <P>
* @author Thorn Green
*/
public class MultiSincCoWaveFormEditor
	...
	*/
	 ...
	 */
	protected GMultiSincCoWaveForm waveForm = null;
	
	/**
	 * Text field for editing the relative frequency of the underlying sinc-co functions.
	 */
	protected JTextField mult = new JTextField();
	
	/**
	 * Text field for editing the notch height of the wave combination.
	 */
	...
	/**
	* Constructs the property editor for a given GMultiSincCoWaveForm.
	* @param in The input GMultiSincCoWaveForm.
	* @param _ins The associated instrument track.
	*/
	public MultiSincCoWaveFormEditor(GMultiSincCoWaveForm in , InstrumentTrack _ins) {
		waveForm = in;
		ins = _ins;
		...
		pan2.add("any", mult);
		pan2.add("any", new JLabel("Notch Height : "));
		pan2.add("any", notchHeight);
		
		mult.setText( "" + waveForm.getMult() );
	...
	* the edited GMultiSincCoWaveForm.
	*/
	public void actionPerformed(ActionEvent e) {
		try {
			final int core = 0;
			
			waveForm.setMult( Double.parseDouble( mult.getText() ) );
