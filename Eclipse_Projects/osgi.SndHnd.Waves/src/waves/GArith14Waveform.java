...
/**
 * 
 * A node representing a waveform taking an input waveform to the fourteenth power.
 * 
 * @author tgreen
 *
 */
public class GArith14Waveform extends GWaveForm  implements Externalizable {
	...
	public WaveForm genWave(HashMap s) {
		...
		Arith14Waveform wv = new Arith14Waveform( w );
		s.put(this, wv);
