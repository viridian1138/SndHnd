...
/**
 * 
 * A node representing a waveform taking an input waveform to the sixth power.
 * 
 * @author tgreen
 *
 */
public class GArithHexWaveform extends GWaveForm  implements Externalizable {
	...
	public WaveForm genWave(HashMap s) {
		...
		ArithHexWaveform wv = new ArithHexWaveform( w );
		s.put(this, wv);
