...
/**
* A property editor for editing a GArithCntWaveform node.
* <P>
* @author Thorn Green
*/
public class ArithCntWaveformEditor
	...
	*/
	 ...
	 * The input waveform.
	 */
	protected GArithCntWaveform waveForm = null;
	
	/**
	 * Text field for editing the maximum iteration count.
	 */
	...
	/**
	* Constructs the property editor for a given GArithCntWaveform.
	* @param in The input GArithCntWaveform.
	* @param _ins The associated instrument track.
	*/
	public ArithCntWaveformEditor(GArithCntWaveform in , InstrumentTrack _ins) {
		waveForm = in;
		ins = _ins;
