...
import waves.undo.pdx_OverdriveViewPaneModel_pdx_ObjectRef;
...
public class OverdriveViewPane extends JComponent implements MouseListener,
	...
	protected pdx_OverdriveViewPaneModel_pdx_ObjectRef model = null;
	...
	public OverdriveViewPane( UndoManager _undoMgr ,
		...
		waves.undo.pdx_OverdriveViewPaneModel_pdx_PairRef pair = waves.undo.pdx_OverdriveViewPaneModel_pdx_ObjectRef.pdxm_new_OverdriveViewPaneModel(
				mil , 0.0 , 0.0 , 0.0 , 0.0 );
		mil = pair.getMilieu();
		model = (waves.undo.pdx_OverdriveViewPaneModel_pdx_ObjectRef)( pair.getObject() );
...
protected void calcPointsInterp(Vector<AazonBaseMutableVect> out) {
	...
	{
		OverdriveGenerateEditor editor = new OverdriveGenerateEditor( this , 
