...
/**
 * 
 * A node representing a waveform taking an input waveform to the twentieth power.
 * 
 * @author tgreen
 *
 */
public class GArith20Waveform extends GWaveForm  implements Externalizable {
	...
	public WaveForm genWave(HashMap s) {
		...
		Arith20Waveform wv = new Arith20Waveform( w );
		s.put(this, wv);
