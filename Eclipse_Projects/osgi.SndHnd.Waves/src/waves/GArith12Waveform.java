...
/**
 * 
 * A node representing a waveform taking an input waveform to the twelfth power.
 * 
 * @author tgreen
 *
 */
public class GArith12Waveform extends GWaveForm  implements Externalizable {
	...
	public WaveForm genWave(HashMap s) {
		...
		Arith12Waveform wv = new Arith12Waveform( w );
		s.put(this, wv);
