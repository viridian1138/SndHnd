...
/**
* A property editor for editing a GBitcrushWaveform node.
* <P>
* @author Thorn Green
*/
public class BitcrushWaveformEditor
	...
	*/
	 ...
	 * The input waveform.
	 */
	protected GBitcrushWaveform waveForm = null;
	
	/**
	 * Text field for editing the multiplier to apply before performing quantization.
	 */
	...
	/**
	* Constructs the property editor for a given GBitcrushWaveform.
	* @param in The input GBitcrushWaveform.
	* @param _ins The associated instrument track.
	*/
	public BitcrushWaveformEditor(GBitcrushWaveform in , InstrumentTrack _ins) {
		waveForm = in;
		ins = _ins;
	...
	* the edited GBitcrushWaveform.
	*/
	public void actionPerformed(ActionEvent e) {
		try {
			final int core = 0;
			
			waveForm.setMult( Long.parseLong( mult.getText() ) );
