...
/**
* A property editor for editing a GChorusLnWaveform node.
* <P>
* @author Thorn Green
*/
public class ChorusLnWaveformEditor
	...
	*/
	 ...
	 * The input waveform.
	 */
	protected GChorusLnWaveform waveForm = null;
	
	/**
	 * Text field for editing the maximum number of chorus waves to add.
	 */
	protected JTextField max = new JTextField();
	
	/**
	 * Text field for editing the increment of the parameter delta for each wave.
	 */
	protected JTextField deltaPerIncr = new JTextField();
	...
	/**
	* Constructs the property editor for a given GChorusLnWaveform.
	* @param in The input GChorusLnWaveform.
	* @param _ins The associated instrument track.
	*/
	public ChorusLnWaveformEditor(GChorusLnWaveform in , InstrumentTrack _ins) {
		waveForm = in;
		ins = _ins;
		...
		pan2.add("any", new JLabel("Mult : "));
		pan2.add("any", max);
		pan2.add("any", new JLabel("Delta Per Incr : "));
		pan2.add("any", deltaPerIncr);
		
		max.setText( "" + waveForm.getMax() );
		deltaPerIncr.setText( "" + waveForm.getDeltaPerIncr() );
	...
	*/
	public void actionPerformed(ActionEvent e) {
		try {
			...
			waveForm.setDeltaPerIncr( Double.parseDouble( deltaPerIncr.getText() ) );
