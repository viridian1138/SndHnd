...
/**
* A property editor for editing a GChorusWaveform node.
* <P>
* @author Thorn Green
*/
public class ChorusWaveformEditor
	...
	*/
	 ...
	 */
	protected GChorusWaveform waveForm = null;
	
	/**
	 * Text field for editing the maximum number of chorus levels to add.
	 */
	protected JTextField max = new JTextField();
	
	/**
	 * Text field for editing the frequency increment or decrement for each chorus level.
	 */
	...
	/**
	* Constructs the property editor for a given GChorusWaveform.
	* @param in The input GChorusWaveform.
	* @param _ins The associated instrument track.
	*/
	public ChorusWaveformEditor(GChorusWaveform in , InstrumentTrack _ins) {
		waveForm = in;
		ins = _ins;
