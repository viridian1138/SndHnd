...
/**
* A property editor for editing a GTriangleWaveform node.
* <P>
* @author Thorn Green
*/
public class TriangleWaveformEditor
	...
	*/
	 ...
	 */
	protected GTriangleWaveform waveForm = null;
	
	/**
	 * Text field for editing the length of the attack for the triangle.
	 */
	...
	/**
	* Constructs the property editor for a given GTriangleWaveform.
	* @param in The input GTriangleWaveform.
	* @param _ins The associated instrument track.
	*/
	public TriangleWaveformEditor(GTriangleWaveform in , InstrumentTrack _ins) {
		waveForm = in;
		ins = _ins;
