 ...
 *
 */
public class GArithGntWaveform extends GWaveForm  implements Externalizable {
	...
	public WaveForm genWave(HashMap s) {
		...
		ArithGntWaveform wv = new ArithGntWaveform( w , max );
		s.put(this, wv);
	...
	public void editProperties( HashMap<String,Object> context )
	{
		...
		ArithGntWaveformEditor editor = new ArithGntWaveformEditor( this , track );
		ProgramDirector.showPropertyEditor(editor, null,
			"ArithGnt Wave Form Properties");
	}
