...
/**
 * Node representing a waveform composed of multiple sinc-co functions that is periodic.
 * 
 * @author tgreen
 *
 */
public class GMultiSincCoWaveForm extends GZWaveBase  implements Externalizable {
	...
	public WaveForm genWave(HashMap s) {
		...
		MultiSincCoWaveForm wv = new MultiSincCoWaveForm( mult , notchHeight );
		s.put(this, wv);
	 ...
	 * @param m The relative frequency of the underlying sinc-co functions.
	...
	public void editProperties( HashMap<String,Object> context )
	{
		...
		MultiSincCoWaveFormEditor editor = new MultiSincCoWaveFormEditor( this , track );
		ProgramDirector.showPropertyEditor(editor, null,
			"Multi SincCo Wave Form Properties");
	}

	/**
	 * Gets the relative frequency of the underlying sinc-co functions.
	 * @return The relative frequency of the underlying sinc-co functions.
	 */
	...
	/**
	 * Sets the relative frequency of the underlying sinc-co functions.
	 * @param mult The relative frequency of the underlying sinc-co functions.
	 */
