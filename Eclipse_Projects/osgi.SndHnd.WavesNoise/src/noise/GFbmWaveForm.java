...
/**
 * A node representing a waveform for fBm (fractional Brownian motion) Noise as described in the book "Texturing and Modeling" by David S. Ebert et. al.
 * @author thorngreen
 *
 */
public class GFbmWaveForm extends GWaveForm implements Externalizable {
	...
	public WaveForm genWave(HashMap s) {
		...
		WaveForm wv = new FbmWaveForm(w, H, lacunarity, octaves);
		s.put(this, wv);
	 ...
	 * @param _chld The input noise function from which the fBm is generated.  Typically this is a lattice noise.
	 ...
	 */
	public void load( GWaveForm _chld , double _H , double _lacunarity , double _octaves )
	{
		chld = _chld;
		H = _H;
	...
	public void editProperties( HashMap<String,Object> context )
	{
		...
		FbmWaveFormEditor editor = new FbmWaveFormEditor( this , track );
		ProgramDirector.showPropertyEditor(editor, null,
			"Fbm Wave Form Properties");
	}
