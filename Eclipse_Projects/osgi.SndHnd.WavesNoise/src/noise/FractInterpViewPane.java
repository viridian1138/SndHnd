...
import noise.undo.pdx_FractInterpViewPaneModel_pdx_ObjectRef;


public class FractInterpViewPane extends JComponent implements MouseListener,
	...
	protected pdx_FractInterpViewPaneModel_pdx_ObjectRef model = null;
	...
	public FractInterpViewPane( UndoManager _undoMgr ,
		...
		numIter = _numIter;
		wv = new FractInterpWaveForm( fractInterpCurve , numIter );
		undoMgr = _undoMgr;
		context = _context;
		track = _track;
		ExtMilieuRef mil = undoMgr.getCurrentMil();
		noise.undo.pdx_FractInterpViewPaneModel_pdx_PairRef pair = noise.undo.pdx_FractInterpViewPaneModel_pdx_ObjectRef.pdxm_new_FractInterpViewPaneModel(
				mil , 0.0 , 0.0 , 0.0 , 0.0 );
		mil = pair.getMilieu();
		model = (noise.undo.pdx_FractInterpViewPaneModel_pdx_ObjectRef)( pair.getObject() );
