...
public class PwFractInterpWaveFormEditor extends JPanel implements ActionListener {
	
	protected GPwFractInterpWaveForm fractInterpWave = null;
	...
	protected PwFractInterpViewPane pane;

	public PwFractInterpWaveFormEditor( GPwFractInterpWaveForm in , PwFractInterpViewPane _pane , InstrumentTrack ins2 ) {
		super();
		fractInterpWave = in;
		pane = _pane;
		track = ins2;
