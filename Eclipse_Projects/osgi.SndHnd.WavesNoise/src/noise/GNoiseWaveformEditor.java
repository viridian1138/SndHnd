...
/**
* A property editor for editing a GGNoiseWaveForm node.
* <P>
* @author Thorn Green
*/
public class GNoiseWaveformEditor
	...
	*/
	 ...
	 */
	protected GGNoiseWaveform waveForm = null;
	
	/**
	 * Text field for editing the sizing multiplier from which to evaluate the input noise.
	 */
	...
	/**
	* Constructs the property editor for a given GGNoiseWaveForm.
	* @param in The input GGNoiseWaveForm.
	* @param _ins The associated instrument track.
	*/
	public GNoiseWaveformEditor(GGNoiseWaveform in , InstrumentTrack _ins) {
		waveForm = in;
		ins = _ins;
