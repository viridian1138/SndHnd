...
/**
* A property editor for editing a GDistNoise node.
* <P>
* @author Thorn Green
*/
public class DistNoiseEditor
	...
	*/
	 ...
	 */
	protected GDistNoise waveForm = null;
	...
	/**
	* Constructs the property editor for a given GDistNoise.
	* @param in The input GDistNoise.
	* @param _ins The associated instrument track.
	*/
	public DistNoiseEditor(GDistNoise in, InstrumentTrack _ins ) {
		waveForm = in;
		ins = _ins;
