...
/**
* A property editor for editing a GDistFbm node.
* <P>
* @author Thorn Green
*/
public class DistFbmEditor
	...
	*/
	 ...
	 */
	protected GDistFbm waveForm = null;
	
	/**
	 * Text field for editing the H parameter of the function.
	 */
	protected JTextField H = new JTextField();
	
	/**
	 * Text field for editing the lacunarity of the function.
	 */
	protected JTextField lacunarity = new JTextField(); 
	
	/**
	 * Text field for editing the number of octaves over which to evaluate the function.
	 */
	protected JTextField octaves = new JTextField(); 
	
	/**
	 * Text field for editing the amount of distortion to apply to the domain.
	 */
	protected JTextField distortion = new JTextField();
	...
	/**
	* Constructs the property editor for a given GDistFbm.
	* @param in The input GDistFbm.
	* @param _ins The associated instrument track.
	*/
	public DistFbmEditor(GDistFbm in , InstrumentTrack _ins ) {
		waveForm = in;
		ins = _ins;
	...
	*/
	public void actionPerformed(ActionEvent e) {
		try {
			...
			waveForm.setDistortion( Double.parseDouble( distortion.getText() ) );
