...
/**
* A property editor for editing a GFractalSum node.
* <P>
* @author Thorn Green
*/
public class FractalSumEditor
	...
	*/
	 ...
	 */
	protected GFractalSum waveForm = null;
	
	/**
	 * Text field for editing the minimum frequency at which to generate the noise fractal.
	 */
	protected JTextField minFreq = new JTextField();
	
	/**
	 * Text field for editing the maximum frequency at which to generate the noise fractal.
	 */
	...
	/**
	* Constructs the property editor for a given GFractalSum.
	* @param in The input GFractalSum.
	* @param _ins The associated instrument track.
	*/
	public FractalSumEditor(GFractalSum in , InstrumentTrack _ins ) {
		waveForm = in;
		ins = _ins;
