...
/**
* A property editor for editing a GFbmWaveForm node.
* <P>
* @author Thorn Green
*/
public class FbmWaveFormEditor
	...
	*/
	 ...
	 */
	protected GFbmWaveForm waveForm = null;
	...
	/**
	* Constructs the property editor for a given GFbmWaveForm.
	* @param in The input GFbmWaveForm.
	* @param _ins The associated instrument track.
	*/
	public FbmWaveFormEditor(GFbmWaveForm in , InstrumentTrack _ins ) {
		waveForm = in;
		ins = _ins;
