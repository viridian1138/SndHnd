...
/**
* A property editor for editing a GHashTimeWaveForm node.
* <P>
* @author Thorn Green
*/
public class HashTimeWaveFormEditor
	...
	*/
	 ...
	 */
	protected GHashTimeWaveForm waveForm = null;
	
	/**
	 * Text field for editing the parameter controlling how much of the input wave allow to pass through unchanged.
	 */
	protected JTextField passThrough = new JTextField();
	...
	/**
	* Constructs the property editor for a given GHashTimeWaveForm.
	* @param in The input GHashTimeWaveForm.
	* @param _ins The associated instrument track.
	*/
	public HashTimeWaveFormEditor(GHashTimeWaveForm in, InstrumentTrack _ins ) {
		waveForm = in;
		ins = _ins;
		...
		pan2.add("any", new JLabel("PassThrough : "));
		pan2.add("any", passThrough);
		
		passThrough.setText( "" + waveForm.getPassThrough() );
	...
	* the edited GHashTimeWaveForm.
	*/
	public void actionPerformed(ActionEvent e) {
		try {
			final int core = 0;
			
			waveForm.setPassThrough( Double.parseDouble( passThrough.getText() ) );
