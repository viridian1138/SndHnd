...
import noise.undo.pdx_PwFractInterpViewPaneModel_pdx_ObjectRef;


public class PwFractInterpViewPane extends JComponent implements MouseListener,
	...
	protected pdx_PwFractInterpViewPaneModel_pdx_ObjectRef model = null;
	...
	public PwFractInterpViewPane( UndoManager _undoMgr ,
		...
		numIter = _numIter;
		wv = new PwFractInterpWaveForm( fractInterpCurve , numIter );
		undoMgr = _undoMgr;
		context = _context;
		track = _track;
		ExtMilieuRef mil = undoMgr.getCurrentMil();
		noise.undo.pdx_PwFractInterpViewPaneModel_pdx_PairRef pair = noise.undo.pdx_PwFractInterpViewPaneModel_pdx_ObjectRef.pdxm_new_PwFractInterpViewPaneModel(
				mil , 0.0 , 0.0 , 0.0 , 0.0 );
		mil = pair.getMilieu();
		model = (noise.undo.pdx_PwFractInterpViewPaneModel_pdx_ObjectRef)( pair.getObject() );
