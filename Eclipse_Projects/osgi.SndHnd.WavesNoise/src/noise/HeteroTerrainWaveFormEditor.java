...
/**
* A property editor for editing a GHeteroTerrainWaveForm node.
* <P>
* @author Thorn Green
*/
public class HeteroTerrainWaveFormEditor
	...
	*/
	 ...
	 */
	protected GHeteroTerrainWaveForm waveForm = null;
	...
	/**
	 * Text field for editing the offset parameter for the function.
	 */
	...
	/**
	* Constructs the property editor for a given GHeteroTerrainWaveForm.
	* @param in The input GHeteroTerrainWaveForm.
	* @param _ins The associated instrument track.
	*/
	public HeteroTerrainWaveFormEditor(GHeteroTerrainWaveForm in , InstrumentTrack _ins) {
		waveForm = in;
		ins = _ins;
	...
	* the edited GHeteroTerrainWaveForm.
	*/
