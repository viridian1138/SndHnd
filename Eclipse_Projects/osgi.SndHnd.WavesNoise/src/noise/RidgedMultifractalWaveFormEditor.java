...
/**
* A property editor for editing a GRidgedMultifractalWaveForm node.
* <P>
* @author Thorn Green
*/
public class RidgedMultifractalWaveFormEditor
	...
	*/
	 ...
	 */
	protected GRidgedMultifractalWaveForm waveForm = null;
	
	/**
	 * Text field for editing the H parameter of the ridged multifractal.
	 */
	protected JTextField H = new JTextField();
	
	/**
	 * Text field for editing the lacunarity of the ridged multifractal.
	 */
	protected JTextField lacunarity = new JTextField(); 
	
	/**
	 * Text field for editing the number of octaves over which to evaluate the ridged multifractal.
	 */
	protected JTextField octaves = new JTextField(); 
	
	/**
	 * Text field for editing the offset parameter for the ridged multifractal.
	 */
	protected JTextField offset = new JTextField();
	
	/**
	 * Text field for editing the gain parameter for the ridged multifractal.
	 */
	...
	/**
	* Constructs the property editor for a given GRidgedMultifractalWaveForm.
	* @param in The input GRidgedMultifractalWaveForm.
	* @param _ins The associated instrument track.
	*/
	public RidgedMultifractalWaveFormEditor(GRidgedMultifractalWaveForm in  , InstrumentTrack _ins) {
		waveForm = in;
		ins = _ins;
	...
	* the edited GRidgedMultifractalWaveForm.
	*/
