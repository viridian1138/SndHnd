...
/**
* A property editor for editing a GPlanetCloudsA node.
* <P>
* @author Thorn Green
*/
public class PlanetCloudsAEditor
	...
	*/
	 ...
	 */
	protected GPlanetCloudsA waveForm = null;
	...
	/**
	* Constructs the property editor for a given GPlanetCloudsA.
	* @param in The input GPlanetCloudsA.
	* @param _ins The associated instrument track.
	*/
	public PlanetCloudsAEditor(GPlanetCloudsA in , InstrumentTrack _ins ) {
		waveForm = in;
		ins = _ins;
