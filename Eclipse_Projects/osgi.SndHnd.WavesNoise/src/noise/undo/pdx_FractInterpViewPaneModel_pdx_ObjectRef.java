...
* From Input File : /Users/thorngreen/svngogl/ddt/trunk/osgi.SndHnd/src/labdaw/undo/FractInterpViewPaneModel.JUndo
**************/

package noise.undo;

public class pdx_FractInterpViewPaneModel_pdx_ObjectRef extends jundo.runtime.ExtObjectRef
	{
protected pdx_FractInterpViewPaneModel_pdx_ObjectRef( jundo.runtime.KeyRef Key )
{
super( Key );
}

public static noise.undo.pdx_FractInterpViewPaneModel_pdx_PairRef createOID_FractInterpViewPaneModel( jundo.runtime.ExtMilieuRef InMil )
{
...
pdx_FractInterpViewPaneModel_pdx_ObjectRef NewObj = 
	new pdx_FractInterpViewPaneModel_pdx_ObjectRef( MyKey );
noise.undo.pdx_FractInterpViewPaneModel_pdx_PairRef ret = new noise.undo.pdx_FractInterpViewPaneModel_pdx_PairRef( NewObj , NewMil );
return( ret );
}
	public static noise.undo.pdx_FractInterpViewPaneModel_pdx_PairRef pdxm_new_FractInterpViewPaneModel( final jundo.runtime.ExtMilieuRef pdx_thismilieu , final double  startParam , final double  endParam , final double  startLevel , final double  endLevel )
{
final noise.undo.pdx_FractInterpViewPaneModel_pdx_PairRef pdx_tmp_3162 = noise.undo.pdx_FractInterpViewPaneModel_pdx_ObjectRef.pdxm_allocate_FractInterpViewPaneModel( ( pdx_thismilieu ) );
final noise.undo.pdx_FractInterpViewPaneModel_pdx_ObjectRef pdx_tmp_3160 = (noise.undo.pdx_FractInterpViewPaneModel_pdx_ObjectRef)( pdx_tmp_3162.getObject() );
...
return( new noise.undo.pdx_FractInterpViewPaneModel_pdx_PairRef( pdx_tmp_3160 , ( pdx_tmp_3960 ) ) );
}
	public static noise.undo.pdx_FractInterpViewPaneModel_pdx_PairRef pdxm_allocate_FractInterpViewPaneModel( final jundo.runtime.ExtMilieuRef pdx_thismilieu )
{
final noise.undo.pdx_FractInterpViewPaneModel_pdx_PairRef t1 = pdx_FractInterpViewPaneModel_pdx_ObjectRef.createOID_FractInterpViewPaneModel( pdx_thismilieu );
final noise.undo.pdx_FractInterpViewPaneModel_pdx_PairRef t2 = pdx_zero( t1.getMilieu() , (noise.undo.pdx_FractInterpViewPaneModel_pdx_ObjectRef)( t1.getObject() ) );

return( t2 );
}
	public static noise.undo.pdx_FractInterpViewPaneModel_pdx_PairRef pdx_zero( final jundo.runtime.ExtMilieuRef pdx_thismilieu , final noise.undo.pdx_FractInterpViewPaneModel_pdx_ObjectRef in )
{
final noise.undo.pdx_FractInterpViewPaneModel_pdx_PairRef tx = new noise.undo.pdx_FractInterpViewPaneModel_pdx_PairRef( in , pdx_thismilieu );
...
final noise.undo.pdx_FractInterpViewPaneModel_pdx_PairRef z = new noise.undo.pdx_FractInterpViewPaneModel_pdx_PairRef( in , t4 );
return( z );
}
