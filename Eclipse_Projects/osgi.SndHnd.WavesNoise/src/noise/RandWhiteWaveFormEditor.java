...
/**
* A property editor for editing a GRandWhiteWaveForm node.
* <P>
* @author Thorn Green
*/
public class RandWhiteWaveFormEditor
	...
	*/
	 ...
	 */
	protected GRandWhiteWaveForm waveForm = null;
	...
	/**
	 * Text field for editing the maximum number of times to run the random number generator through the initial seed.
	 */
	...
	/**
	 * Constructs the property editor for a given GRandWhiteWaveForm.
	 * @param in The input GRandWhiteWaveForm.
	 * @param _ins The associated instrument track.
	 */
	public RandWhiteWaveFormEditor(GRandWhiteWaveForm in , InstrumentTrack _ins) {
		waveForm = in;
		ins = _ins;
