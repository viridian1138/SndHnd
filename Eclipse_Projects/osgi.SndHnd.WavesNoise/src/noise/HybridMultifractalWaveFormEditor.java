...
/**
* A property editor for editing a GHybridMultifractalWaveForm node.
* <P>
* @author Thorn Green
*/
public class HybridMultifractalWaveFormEditor
	...
	*/
	 ...
	 */
	protected GHybridMultifractalWaveForm waveForm = null;
	
	/**
	 * Text field for editing the H parameter of the hybrid multifractal.
	 */
	protected JTextField H = new JTextField();
	
	/**
	 * Text field for editing the lacunarity of the hybrid multifractal.
	 */
	protected JTextField lacunarity = new JTextField(); 
	
	/**
	 * Text field for editing the number of octaves over which to evaluate the hybrid multifractal.
	 */
	protected JTextField octaves = new JTextField(); 
	
	/**
	 * Text field for editing the offset parameter for the hybrid multifractal.
	 */
	...
	/**
	* Constructs the property editor for a given GHybridMultifractalWaveForm.
	* @param in The input GHybridMultifractalWaveForm.
	* @param _ins The associated instrument track.
	*/
	public HybridMultifractalWaveFormEditor(GHybridMultifractalWaveForm in , InstrumentTrack _ins) {
		waveForm = in;
		ins = _ins;
	...
	* the edited GHybridMultifractalWaveForm.
	*/
