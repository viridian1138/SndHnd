...
public class FractInterpWaveFormEditor extends JPanel implements ActionListener {
	
	protected GFractInterpWaveForm fractInterpWave = null;
	...
	protected FractInterpViewPane pane;

	public FractInterpWaveFormEditor( GFractInterpWaveForm in , FractInterpViewPane _pane , InstrumentTrack ins2 ) {
		super();
		fractInterpWave = in;
		pane = _pane;
		track = ins2;
