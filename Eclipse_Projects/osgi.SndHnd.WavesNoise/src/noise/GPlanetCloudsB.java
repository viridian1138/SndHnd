 ...
 *
 */
public class GPlanetCloudsB extends GWaveForm implements Externalizable {
	...
	public WaveForm genWave(HashMap s) {
		...
		WaveForm wv = planetCloudsB(w, distortionscale, H, lacunarity, octaves);
		s.put(this, wv);
	 ...
	 */
	public static WaveForm planetCloudsB(WaveForm noise,
			double distortionscale, double H, double lacunarity,
			double octaves) {
		VfbmWaveform vf = new VfbmWaveform(noise, octaves, lacunarity, H);
		PhaseDistortionPacket distort = new PhaseDistortionPacket(vf, 1.0, distortionscale);
	...
	public void editProperties( HashMap<String,Object> context )
	{
		...
		PlanetCloudsBEditor editor = new PlanetCloudsBEditor( this , track );
		ProgramDirector.showPropertyEditor(editor, null,
			"Planet Clouds B Properties");
	}
