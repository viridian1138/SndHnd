...
/**
* A property editor for editing a GWardNoiseWaveform node.
* <P>
* @author Thorn Green
*/
public class WardNoiseWaveformEditor
	...
	*/
	 ...
	 */
	protected GWardNoiseWaveform waveForm = null;
	
	/**
	 * Text field for editing the size of the interval over which define the evaluation interval of the hermite function.
	 */
	...
	/**
	* Constructs the property editor for a given GWardNoiseWaveform.
	* @param in The input GWardNoiseWaveform.
	* @param _ins The associated instrument track.
	*/
	public WardNoiseWaveformEditor(GWardNoiseWaveform in  , InstrumentTrack _ins) {
		waveForm = in;
		ins = _ins;
