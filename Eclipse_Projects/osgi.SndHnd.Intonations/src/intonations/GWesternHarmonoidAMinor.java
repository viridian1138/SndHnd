...
/**
 * A node representing a western 12-tone intonation in A-Minor that is similar to a just intonation, but uses
 ...
 *
 */
public class GWesternHarmonoidAMinor extends GZWesternIntonationBase implements Externalizable {

	/**
	 * Constructs the node.
	 */
	public GWesternHarmonoidAMinor() {
	}
	...
	public Intonation genInton(HashMap s) {
		...
		WesternHarmonoidAMinor wv = new WesternHarmonoidAMinor();
		s.put(this, wv);
