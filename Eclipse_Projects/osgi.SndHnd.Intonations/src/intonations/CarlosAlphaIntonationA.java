...
/**
 * Diatonic approximation of the Wendy Carlos alpha intonation in the key of A.
 * See https://en.wikipedia.org/wiki/Alpha_scale
 * 
 * @author tgreen
 *
 */
public class CarlosAlphaIntonationA extends CarlosAlphaIntonation {
	
	/**
	 * Constructs the intonation.
	 */
	public CarlosAlphaIntonationA()
	{
	}
	...
	public GIntonation genInton(HashMap s) {
		...
		GCarlosAlphaIntonationA wv = new GCarlosAlphaIntonationA();
		s.put(this, wv);
		return( wv );
	}
