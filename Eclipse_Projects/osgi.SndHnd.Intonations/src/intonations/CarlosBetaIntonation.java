...
/**
 * Approximation of the Wendy Carlos beta intonation.  This version builds the melodic
 * interval from three applications of a ( 21.266 ) * 12 cent increase (essentially a minor third).
 * This puts the total ratio for a scale step close to the quoted value
 * (see the Wikipedia article) of 63.8 cents.
 * 
 ...
 *
 */
public abstract class CarlosBetaIntonation extends Intonation {
	
	public static final double BETA_MULT_INTERVAL = Math.pow( 2.0 , 0.212666666666666666666666666666666 );
	...
	{
		double in = iin;
		final double vval = CarlosBetaIntonationA.calcIntonationVal( index );
		while( ( MSQRT * in ) <= vval )
		{
