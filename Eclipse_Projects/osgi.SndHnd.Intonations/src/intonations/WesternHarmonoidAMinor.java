...
/**
 * A western 12-tone intonation in A-Minor that is similar to a just intonation, but uses
 ...
 *
 */
public class WesternHarmonoidAMinor extends WesternIntonation {

	/**
	 * Constructs the intonation.
	 */
	public WesternHarmonoidAMinor() {
	}
	...
	public GIntonation genInton(HashMap s) {
		...
		GWesternHarmonoidAMinor wv = new GWesternHarmonoidAMinor();
		s.put(this, wv);
		return( wv );
	}
