...
/**
 * A just pentatonic intonation in the key of A.
 * 
 * @author tgreen
 *
 */
public class JustPenatonicIntonationA extends PentatonicIntonation {

	public static final double TUNE_0 = 1.0;
	
	public static final double TUNE_1 = 9.0 / 8.0;
	
	public static final double TUNE_2 = 5.0 / 4.0;

	public static final double TUNE_3 = 3.0 / 2.0;
	
	public static final double TUNE_4 = 5.0 / 3.0;
	 ...
	 */
	public JustPenatonicIntonationA()
	{
	}
	...
	/**
	 * Returns the pitch ratio for a particular number of pentatonic steps.
	 * @param numSteps The number of pentatonic steps.
	...
	public GIntonation genInton(HashMap s) {
		...
		GJustPenatonicIntonationA wv = new GJustPenatonicIntonationA();
		s.put(this, wv);
		return( wv );
	}
