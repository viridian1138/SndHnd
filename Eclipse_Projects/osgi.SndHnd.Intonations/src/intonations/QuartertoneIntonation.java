...
/**
 * Abstract base class for a quartertone intonation.
 * @author tgreen
 *
 */
public abstract class QuartertoneIntonation extends Intonation {
	...
	{
		double in = iin;
		final double vval = DiatonicQuartertoneIntonationA.calcIntonationVal( index );
		while( ( MSQRT * in ) <= vval )
		{
			in = in * 2.0;
		}
