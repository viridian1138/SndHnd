...
/**
 * Diatonic approximation of the Wendy Carlos beta intonation in the key of A.
 * See https://en.wikipedia.org/wiki/Beta_scale
 * 
 * @author tgreen
 *
 */
public class CarlosBetaIntonationA extends CarlosBetaIntonation {
	
	/**
	 * Constructs the intonation.
	 */
	public CarlosBetaIntonationA()
	{
	}
	...
	public GIntonation genInton(HashMap s) {
		...
		GCarlosBetaIntonationA wv = new GCarlosBetaIntonationA();
		s.put(this, wv);
		return( wv );
	}
