...
/**
 * An abstract base class for a Partch 43-tone intonation.
 * See https://en.wikipedia.org/wiki/Harry_Partch's_43-tone_scale
 * @author tgreen
 *
 */
public abstract class PartchIntonation43 extends Intonation {
	...
	{
		double in = iin;
		final double vval = JustPartchIntonation43A.calcIntonationVal( index );
		while( ( MSQRT * in ) <= vval )
		{
			in = in * 2.0;
		}
