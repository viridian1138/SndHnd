...
/**
* A property editor for editing a GHarmonyCutter node.
* <P>
* @author Thorn Green
*/
public class HarmonyCutterEditor
	...
	*/
	 ...
	 */
	protected GHarmonyCutter waveForm = null;
	
	/**
	 * Text field for editing the string indicating which pitches are to be removed.
	 */
	...
	/**
	* Constructs the property editor for a given GHarmonyCutter.
	* @param in The input GHarmonyCutter.
	*/
	public HarmonyCutterEditor(GHarmonyCutter in ) {
		waveForm = in;
