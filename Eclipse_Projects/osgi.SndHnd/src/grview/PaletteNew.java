...
/**
 * Defines the palette button for the "create new" mode.
 * 
 * @author tgreen
 *
 */
public class PaletteNew {
	...
	public static AazonImmutableSharedEnt getRectGrpOn(Object univ) {
		if (rectGpOn.get(univ) == null) {
			...
			final AazonEnt linea3 = AazonSmartLine.construct(
					new AazonBaseImmutableVect( ( -0.075 + -0.0125 ) / 2.0 , -0.075) ,
					new AazonBaseImmutableVect( ( -0.075 + -0.0125 ) / 2.0 , -0.0125), AczonColor
							.getLineMagenta(), false);
			
			final AazonEnt linea4 = AazonSmartLine.construct(
					new AazonBaseImmutableVect( -0.075 , ( -0.075 + -0.0125 ) / 2.0 ) ,
					new AazonBaseImmutableVect( -0.0125 , ( -0.075 + -0.0125 ) / 2.0 ), AczonColor
							.getLineMagenta(), false);
			
			final AazonEnt rectR = AazonSmartOutlineRectangle.construct(
					new AazonBaseImmutableVect(0.0125, 0.0125),
					new AazonBaseImmutableVect(0.075, 0.075), AczonColor
							.getLineMagenta(), false);

			final AazonEnt[] entsRect = { rect , rectO, linea1 , linea2 , linea3 , linea4 , rectR };
