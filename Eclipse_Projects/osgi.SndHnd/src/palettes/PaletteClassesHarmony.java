...
/**
 * Defines state information for the palette used when editing an instance of class EditPackHarmony.
 * 
 * @author tgreen
 *
 */
public class PaletteClassesHarmony implements IPalette {
