...
/**
 * Defines state information for the palette used when editing an instance of class EditPackIntonation.
 * 
 * @author tgreen
 *
 */
public class PaletteClassesIntonation implements IPalette {
	...
	static
	{
		...
		try
		{
			addClass( GDiatonicIntonationAMinor.class );
	...
	public static synchronized void addClass( Class<? extends GNode> clss ) throws Throwable
	{
		...
		fireToListeners();
		PaletteClassesHarmony.addClass( clss );
	...
	public static synchronized void removeClass( Class<? extends GNode> clss ) throws Throwable
	{
		...
		fireToListeners();
		PaletteClassesHarmony.removeClass( clss );
