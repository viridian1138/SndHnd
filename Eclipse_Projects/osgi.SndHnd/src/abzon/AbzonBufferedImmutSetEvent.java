 ...
 *
 */
public class AbzonBufferedImmutSetEvent implements AazonListener {
	 ...
	 */
	public AbzonBufferedImmutSetEvent( AazonMutableVect _cin , AazonImmutSetMutableVect _cout )
	{
		cin = _cin;
		cout = _cout;
		cin.add( this );
	...
	{
		cout.setCoords( AazonBufferedImmutableVect.construct( cin ) );
	}
