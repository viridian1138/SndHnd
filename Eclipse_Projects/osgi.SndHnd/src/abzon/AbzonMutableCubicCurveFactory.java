...
/**
 * A mutable AbzonPathIteratorFactory for a cubic Bezier curve.
 * 
 * @author tgreen
 *
 */
public class AbzonMutableCubicCurveFactory extends
		AbzonMutablePathIteratorFactory {
	
	/**
	 * The current state of the mutable factory.
	 */
	AbzonImmutableCubicCurveFactory crv;
	
	/**
	 * Constructs the mutable factory.
	 * @param _crv The initial state of the mutable factory.
	 */
	public AbzonMutableCubicCurveFactory( AbzonImmutableCubicCurveFactory _crv )
	{
		crv = _crv;
	}
	 ...
	 */
	public void setCrv( AbzonImmutableCubicCurveFactory _crv )
	{
		crv = _crv;
		fire();
	}
