...
/**
 * AazonEnt for a mutable block of text.
 * 
 * @author tgreen
 *
 */
public class AazonMutableBlockText extends AazonMutableGroupBase implements
		AazonMutableEnt {
	
	/**
	 * The current state of the mutable AazonEnt.
	 */
	AazonImmutableBlockText rect;
	
	/**
	 * Constructs the AazonMutableBlockText.
	 * @param _rect The current state of the mutable AazonEnt.
	 */
	public AazonMutableBlockText( AazonImmutableBlockText _rect )
	{	
		setRect( _rect );
	}
	 ...
	 */
	public void setRect( AazonImmutableBlockText ord )
	{
		rect = ord;
		if( init )
		{
