 ...
 *
 */
public class AazonMutableScalarDivideVect extends AazonMutableVect implements AazonListener {
	 ...
	 */
	private AazonMutableScalarDivideVect( AazonVect _a , AazonDbl _b )
	{
		a = _a;
		b = _b;
	 ...
	 */
	public static AazonVect construct( AazonVect _a , AazonDbl _b )
	{
		if( ( _a instanceof AazonImmutableVect ) && ( _b instanceof AazonImmutableDbl ) )
		{
			return( AazonImmutableScalarDivideVect.construct( (AazonImmutableVect) _a , (AazonImmutableDbl) _b ) );
		}
		return( new AazonMutableScalarDivideVect( _a , _b ) );
	}
