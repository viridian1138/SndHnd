...
/**
 * Aazon mutable vector representing the vector subtraction of two input vectors.
 * 
 * @author tgreen
 *
 */
public class AazonMutableSubtractVect extends AazonMutableVect implements AazonListener {
	 ...
	 */
	private AazonMutableSubtractVect( AazonVect _a , AazonVect _b )
	{
		a = _a;
		b = _b;
	...
	/**
	 * Constructs an Aazon vector representing the vector subtraction of two input vectors.
	 * @param _a First argument of the vector subtraction.
	 * @param _b Second argument of the vector subtraction.
	...
	public static AazonVect construct( AazonVect _a , AazonVect _b )
	{
		...
		{
			return( AazonImmutableSubtractVect.construct( (AazonImmutableVect) _a , (AazonImmutableVect) _b ) );
		}
		return( new AazonMutableSubtractVect( _a , _b ) );
	}
