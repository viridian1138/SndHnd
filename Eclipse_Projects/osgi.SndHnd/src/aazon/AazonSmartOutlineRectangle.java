...
/**
 * An AazonEnt for a mutable outline of a rectangle between two vector corner points.
 * 
 * @author tgreen
 *
 */
public class AazonSmartOutlineRectangle implements AazonMutableEnt, AazonListener {
	
	/**
	 * The current state of the mutable rectangle outline.
	 */
	protected AazonMutableOutlineRectangle ent;
	 ...
	 * @param _app The appearance of the outline of the rectangle.
	 */
	private AazonSmartOutlineRectangle( AazonVect _a , AazonVect _b , Appearance _app )
	{
		a = _a;
		b = _b;
		app = _app;
		AazonImmutableOutlineRectangle rect = new AazonImmutableOutlineRectangle( AazonBufferedImmutableVect.construct( a ) , 
				AazonBufferedImmutableVect.construct( b ) , app );
		ent = new AazonMutableOutlineRectangle( rect );
	...
	/**
	 * Sets the appearance of the rectangle outline.
	 * @param _app The appearance of the rectangle outline.
	 */
	...
	/**
	 * Returns an AazonEnt for a outline of a rectangle between two vector corner points.
	 * @param _a Vector to the first corner of the rectangle.
	 * @param _b Vector to the second corner of the rectangle.
	 * @param _app The appearance of the rectangle outline.
	 * @param forceMute Whether to force the production of the AazonEnt to be done as if the shape was mutable.
	 * @return An AazonEnt for the outline of a rectangle between two vector corner points.
	 */
	public static AazonEnt construct( AazonVect _a , AazonVect _b , Appearance _app , boolean forceMute )
	{
		...
		{
			return( new AazonImmutableOutlineRectangle( (AazonImmutableVect) _a ,  (AazonImmutableVect) _b , _app ) );
		}
		
		return( new AazonSmartOutlineRectangle( _a , _b , _app ) );
	}
