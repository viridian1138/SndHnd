...
public class pdx_PiecewiseCubicMonotoneBezierFlatViewPaneModel_pdx_ObjectRef extends jundo.runtime.ExtObjectRef
	{
protected pdx_PiecewiseCubicMonotoneBezierFlatViewPaneModel_pdx_ObjectRef( jundo.runtime.KeyRef Key )
{
super( Key );
}

public static labdaw.undo.pdx_PiecewiseCubicMonotoneBezierFlatViewPaneModel_pdx_PairRef createOID_PiecewiseCubicMonotoneBezierFlatViewPaneModel( jundo.runtime.ExtMilieuRef InMil )
{
...
pdx_PiecewiseCubicMonotoneBezierFlatViewPaneModel_pdx_ObjectRef NewObj = 
	new pdx_PiecewiseCubicMonotoneBezierFlatViewPaneModel_pdx_ObjectRef( MyKey );
labdaw.undo.pdx_PiecewiseCubicMonotoneBezierFlatViewPaneModel_pdx_PairRef ret = new labdaw.undo.pdx_PiecewiseCubicMonotoneBezierFlatViewPaneModel_pdx_PairRef( NewObj , NewMil );
return( ret );
}
	public static labdaw.undo.pdx_PiecewiseCubicMonotoneBezierFlatViewPaneModel_pdx_PairRef pdxm_new_PiecewiseCubicMonotoneBezierFlatViewPaneModel( final jundo.runtime.ExtMilieuRef pdx_thismilieu , final double  startParam , final double  endParam , final double  startLevel , final double  endLevel )
{
final labdaw.undo.pdx_PiecewiseCubicMonotoneBezierFlatViewPaneModel_pdx_PairRef pdx_tmp_3162 = labdaw.undo.pdx_PiecewiseCubicMonotoneBezierFlatViewPaneModel_pdx_ObjectRef.pdxm_allocate_PiecewiseCubicMonotoneBezierFlatViewPaneModel( ( pdx_thismilieu ) );
final labdaw.undo.pdx_PiecewiseCubicMonotoneBezierFlatViewPaneModel_pdx_ObjectRef pdx_tmp_3160 = (labdaw.undo.pdx_PiecewiseCubicMonotoneBezierFlatViewPaneModel_pdx_ObjectRef)( pdx_tmp_3162.getObject() );
...
return( new labdaw.undo.pdx_PiecewiseCubicMonotoneBezierFlatViewPaneModel_pdx_PairRef( pdx_tmp_3160 , ( pdx_tmp_3960 ) ) );
}
	public static labdaw.undo.pdx_PiecewiseCubicMonotoneBezierFlatViewPaneModel_pdx_PairRef pdxm_allocate_PiecewiseCubicMonotoneBezierFlatViewPaneModel( final jundo.runtime.ExtMilieuRef pdx_thismilieu )
{
final labdaw.undo.pdx_PiecewiseCubicMonotoneBezierFlatViewPaneModel_pdx_PairRef t1 = pdx_PiecewiseCubicMonotoneBezierFlatViewPaneModel_pdx_ObjectRef.createOID_PiecewiseCubicMonotoneBezierFlatViewPaneModel( pdx_thismilieu );
final labdaw.undo.pdx_PiecewiseCubicMonotoneBezierFlatViewPaneModel_pdx_PairRef t2 = pdx_zero( t1.getMilieu() , (labdaw.undo.pdx_PiecewiseCubicMonotoneBezierFlatViewPaneModel_pdx_ObjectRef)( t1.getObject() ) );

return( t2 );
}
	public static labdaw.undo.pdx_PiecewiseCubicMonotoneBezierFlatViewPaneModel_pdx_PairRef pdx_zero( final jundo.runtime.ExtMilieuRef pdx_thismilieu , final labdaw.undo.pdx_PiecewiseCubicMonotoneBezierFlatViewPaneModel_pdx_ObjectRef in )
{
final labdaw.undo.pdx_PiecewiseCubicMonotoneBezierFlatViewPaneModel_pdx_PairRef tx = new labdaw.undo.pdx_PiecewiseCubicMonotoneBezierFlatViewPaneModel_pdx_PairRef( in , pdx_thismilieu );
...
final labdaw.undo.pdx_PiecewiseCubicMonotoneBezierFlatViewPaneModel_pdx_PairRef z = new labdaw.undo.pdx_PiecewiseCubicMonotoneBezierFlatViewPaneModel_pdx_PairRef( in , t4 );
return( z );
}
