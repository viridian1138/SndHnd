...
public class PseudoLoopBuilderController extends JPanel implements ActionListener {
	...
	protected JMenuItem editPortamento = new JMenuItem( "Edit Portamento..." );
	
	protected JMenuItem editVibrato = new JMenuItem( "Edit Vibrato..." );
	...
	protected JMenuItem dumpWaveform = new JMenuItem( "Dump Waveform" );
	
	
	
	protected PseudoLoopBuilder pane;

	public PseudoLoopBuilderController( PseudoLoopBuilder _pane ) {
		super();
		pane = _pane;
		...
		menu.add(editPortamento);
		menu.add(editVibrato);
