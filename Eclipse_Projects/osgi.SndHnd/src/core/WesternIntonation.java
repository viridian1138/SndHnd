...
/**
 * An abstract base class for a western 12-tone intonation and scale.
 * 
 * @author tgreen
 *
 */
public abstract class WesternIntonation extends Intonation {
	...
	{
		double in = iin;
		final double vval = DiatonicIntonationAMinor.calcIntonationVal( index );
		while( ( MSQRT * in ) <= vval )
		{
			in = in * 2.0;
		}
