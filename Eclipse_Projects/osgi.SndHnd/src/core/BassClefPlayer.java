...
/**
 * A mostly tutorial GUI for playing normal bass-clef pitches.
 * 
 * @author tgreen
 *
 */
public class BassClefPlayer extends PropertyEditAdapter implements
	ActionListener {
	...
	/**
	 * Handles a button-press by asserting the Apply button actions or by playing one of the bass clef notes.
	 */
	public void actionPerformed(ActionEvent e) {
		...
		if( src != applyButton )
		{
			...
			{
			case 'G':
				freq = NoteTable.getNoteFrequencyEqualTemperedScale_Intl( 2 , NoteTable.STEPS_G + shp );
				fa = NoteTable.getNoteFrequencyEqualTemperedScale_Intl( 2 , NoteTable.STEPS_G );
				break;
			case 'a':
				freq = NoteTable.getNoteFrequencyEqualTemperedScale_Intl( 2 , NoteTable.STEPS_A + shp );
				fa = NoteTable.getNoteFrequencyEqualTemperedScale_Intl( 2 , NoteTable.STEPS_A );
				break;
			case 'B':
				freq = NoteTable.getNoteFrequencyEqualTemperedScale_Intl( 2 , NoteTable.STEPS_B + shp );
				fa = NoteTable.getNoteFrequencyEqualTemperedScale_Intl( 2 , NoteTable.STEPS_B );
				break;
			case 'c':
				freq = NoteTable.getNoteFrequencyEqualTemperedScale_Intl( 3 , NoteTable.STEPS_C + shp );
				fa = NoteTable.getNoteFrequencyEqualTemperedScale_Intl( 3 , NoteTable.STEPS_C );
				break;
			case 'D':
				freq = NoteTable.getNoteFrequencyEqualTemperedScale_Intl( 3 , NoteTable.STEPS_D + shp );
				fa = NoteTable.getNoteFrequencyEqualTemperedScale_Intl( 3 , NoteTable.STEPS_D );
				break;
			case 'e':
				freq = NoteTable.getNoteFrequencyEqualTemperedScale_Intl( 3 , NoteTable.STEPS_E + shp );
				fa = NoteTable.getNoteFrequencyEqualTemperedScale_Intl( 3 , NoteTable.STEPS_E );
				break;
			case 'F':
				freq = NoteTable.getNoteFrequencyEqualTemperedScale_Intl( 3 , NoteTable.STEPS_F + shp );
				fa = NoteTable.getNoteFrequencyEqualTemperedScale_Intl( 3 , NoteTable.STEPS_F );
				break;
			case 'g':
				freq = NoteTable.getNoteFrequencyEqualTemperedScale_Intl( 3 , NoteTable.STEPS_G + shp );
				fa = NoteTable.getNoteFrequencyEqualTemperedScale_Intl( 3 , NoteTable.STEPS_G );
				break;
			case 'A':
				freq = NoteTable.getNoteFrequencyEqualTemperedScale_Intl( 3 , NoteTable.STEPS_A + shp );
				fa = NoteTable.getNoteFrequencyEqualTemperedScale_Intl( 3 , NoteTable.STEPS_A );
				break;
			case 'b':
				freq = NoteTable.getNoteFrequencyEqualTemperedScale_Intl( 3 , NoteTable.STEPS_B + shp );
				fa = NoteTable.getNoteFrequencyEqualTemperedScale_Intl( 3 , NoteTable.STEPS_B );
				break;
			case 'C':
				freq = NoteTable.getNoteFrequencyEqualTemperedScale_Intl( 4 , NoteTable.STEPS_C + shp );
				fa = NoteTable.getNoteFrequencyEqualTemperedScale_Intl( 4 , NoteTable.STEPS_C );
				break;
			case 'd':
				freq = NoteTable.getNoteFrequencyEqualTemperedScale_Intl( 4 , NoteTable.STEPS_D + shp );
				fa = NoteTable.getNoteFrequencyEqualTemperedScale_Intl( 4 , NoteTable.STEPS_D );
				break;
			case 'E':
