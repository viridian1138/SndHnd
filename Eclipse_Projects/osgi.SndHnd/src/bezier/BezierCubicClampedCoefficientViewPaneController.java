...
public class BezierCubicClampedCoefficientViewPaneController extends JPanel implements ActionListener {
	...
	protected BezierCubicClampedCoefficientViewPane pane;

	public BezierCubicClampedCoefficientViewPaneController( BezierCubicClampedCoefficientViewPane _pane ) {
		super();
		pane = _pane;
