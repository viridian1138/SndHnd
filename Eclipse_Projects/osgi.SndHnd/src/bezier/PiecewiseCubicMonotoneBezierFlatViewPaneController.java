...
public class PiecewiseCubicMonotoneBezierFlatViewPaneController extends JPanel implements ActionListener {
	...
	protected PiecewiseCubicMonotoneBezierFlatViewPane pane;

	public PiecewiseCubicMonotoneBezierFlatViewPaneController( PiecewiseCubicMonotoneBezierFlatViewPane _pane ) {
		super();
		pane = _pane;
