...
/**
 * Tests the ability to drag a rectangle that is connected to a series of transforms.
 * 
 * @author tgreen
 *
 */
public class DraggableTransformTest implements MouseListener, MouseMotionListener {
	 ...
	 */
	protected static DraggableTransformTest dr;
	 ...
	 */
	public DraggableTransformTest( AczonRootFactory _af , AazonBaseMutableVect _centerVect , AazonVect _box0 , AazonVect _box1 , AazonMutableVect _resizeVect )
	{
		af = _af;
	...
	public static void main(String[] args) {
		...
		final AazonEnt liner1 = AazonSmartLine.construct( new AazonBaseImmutableVect( 0.0 , 0.0 ) , new AazonBaseImmutableVect( 0.05 , 0.0 ) , AczonColor.getLineMagenta() , false );
		
		final AazonEnt liner2 = AazonSmartLine.construct( new AazonBaseImmutableVect( 0.05 , 0.0 ) , new AazonBaseImmutableVect( 0.05 , 0.05 ) , AczonColor.getLineMagenta() , false );
		
		final AazonEnt liner3 = AazonSmartLine.construct( new AazonBaseImmutableVect( 0.05 , 0.05 ) , new AazonBaseImmutableVect( 0.0 , 0.0 ) , AczonColor.getLineMagenta() , false );
		
		final AazonEnt[] entsRect = { rect , rectO , liner1 , liner2 , liner3 };
		
		final AazonImmutableOrderedGroup rectGp = new AazonImmutableOrderedGroup( entsRect );
		
		final AazonEnt rectTrans = AazonSmartTranslation.construct( rectGp , centerVect );
		...
		final AazonEnt[] ents1 = { gp0 , ln0 , rectTrans };
		...
		dr = new DraggableTransformTest( af , centerVect , box0 , box1 , af.constructResizeVect( mf ) );
