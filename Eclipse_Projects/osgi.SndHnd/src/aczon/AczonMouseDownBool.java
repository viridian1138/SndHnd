...
/***
 * Aczon boolean representing whether the mouse button is down.
 * 
 * @author tgreen
 *
 */
public class AczonMouseDownBool extends AazonMutableBool implements MouseListener {
	...
	{
		handleSet( AazonBaseImmutableBool.construct( ( arg0.getModifiers() & MouseEvent.BUTTON1_DOWN_MASK ) != 0 ) );
	}
