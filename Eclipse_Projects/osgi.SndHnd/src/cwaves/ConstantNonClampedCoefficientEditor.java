...
/**
* A property editor for editing a GConstantNonClampedCoefficient node.
* <P>
* @author Thorn Green
*/
public class ConstantNonClampedCoefficientEditor
	...
	*/
	 ...
	 */
	protected GConstantNonClampedCoefficient waveForm = null;
	
	/**
	 * Text field for editing the constant value.
	 */
	...
	/**
	* Constructs the property editor for a given GConstantNonClampedCoefficient.
	* @param in The input GConstantNonClampedCoefficient.
	* @param _ins The associated instrument track.
	*/
	public ConstantNonClampedCoefficientEditor(GConstantNonClampedCoefficient in , InstrumentTrack _ins) {
		waveForm = in;
		ins = _ins;
	...
	* the edited GConstantNonClampedCoefficient.
	*/
