...
/**
* A property editor for editing a GHighPassFilterCoeff node.
* <P>
* @author Thorn Green
*/
public class HighPassFilterCoeffEditor
	...
	*/
	 ...
	 */
	protected GHighPassFilterCoeff waveForm = null;
	...
	/**
	* Constructs the property editor for a given GHighPassFilterCoeff.
	* @param in The input GHighPassFilterCoeff.
	* @param _ins The associated instrument track.
	*/
	public HighPassFilterCoeffEditor(GHighPassFilterCoeff in , InstrumentTrack ins2 ) {
		waveForm = in;
		track = ins2;
	...
	* the edited GHighPassFilterCoeff.
	*/
