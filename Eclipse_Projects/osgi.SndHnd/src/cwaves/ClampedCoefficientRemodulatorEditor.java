...
/**
* A property editor for editing a GClampedCoefficientRemodulator node.
* <P>
* @author Thorn Green
*/
public class ClampedCoefficientRemodulatorEditor
	...
	*/
	 ...
	 */
	protected GClampedCoefficientRemodulator waveForm = null;
	...
	/**
	 * Text field for editing the input parameter multiplier.
	 */
	protected JTextField multiplier = new JTextField();
	

	
	/**
	* Constructs the property editor for a given GClampedCoefficientRemodulator.
	* @param in The input GClampedCoefficientRemodulator.
	* @param _ins The associated instrument track.
	*/
	public ClampedCoefficientRemodulatorEditor(GClampedCoefficientRemodulator in , InstrumentTrack ins2 ) {
		waveForm = in;
		track = ins2;
		...
		pan2.add("any", new JLabel("Multiplier : "));
		pan2.add("any", multiplier);
		
		multiplier.setText( "" + waveForm.getMultiplier() );
	...
	* the edited GClampedCoefficientRemodulator.
	*/
	public void actionPerformed(ActionEvent e) {
		try {
			final int core = 0;
			
			waveForm.setMultiplier( Double.parseDouble( multiplier.getText() ) );
