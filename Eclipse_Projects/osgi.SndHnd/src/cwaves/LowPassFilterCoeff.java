...
/**
 * A non-clamped coefficient implementing a low-pass filter on an input non-clamped coefficient.
 * 
 ...
 *
 */
public class LowPassFilterCoeff extends NonClampedCoefficient {

	/**
	 * The input non-clamped coefficient.
	 */
	protected NonClampedCoefficient wave;
	 ...
	 */
	public LowPassFilterCoeff( NonClampedCoefficient _wave , double _intervalHalfLength , int _sampleLen )
	{
		super();
		wave = _wave;
	...
	public NonClampedCoefficient genClone() throws Throwable
	{
		...
		{
			return( new LowPassFilterCoeff( wv , intervalHalfLength , sampleLen ) );
		}
	}
	...
	public GNonClampedCoefficient genCoeff( HashMap<Object,GNode> s )
	{
		...
		GLowPassFilterCoeff wv = new GLowPassFilterCoeff();
		s.put(this, wv);
	...
	public double eval(double param) {
		...
		double b1 = calcApproxB1( sampleLen + 2 , b0 , b2 , intervalStart , intervalEnd );
	...
	public void readExternal(ObjectInput in) throws IOException,
		...
		try {
			...
			wave = (NonClampedCoefficient)( myv.getProperty("Wave") );
	 ...
	 */
	public double calcApproxB1(int len, double b0, double b2, double intervalStart, double intervalEnd ) {
		int count = 0;
		double ptTotal = 0.0;
