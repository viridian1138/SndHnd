...
/**
* A property editor for editing a GConstantClampedCoefficient node.
* <P>
* @author Thorn Green
*/
public class ConstantClampedCoefficientEditor
	...
	*/
	 ...
	 */
	protected GConstantClampedCoefficient waveForm = null;
	...
	/**
	* Constructs the property editor for a given GConstantClampedCoefficient.
	* @param in The input GConstantClampedCoefficient.
	* @param _ins The associated instrument track.
	*/
	public ConstantClampedCoefficientEditor(GConstantClampedCoefficient in , InstrumentTrack _ins) {
		waveForm = in;
		ins = _ins;
	...
	* the edited GConstantClampedCoefficient.
	*/
