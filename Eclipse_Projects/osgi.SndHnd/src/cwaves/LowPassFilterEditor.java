...
/**
* A property editor for editing a GLowPassFilter node.
* <P>
* @author Thorn Green
*/
public class LowPassFilterEditor
	...
	*/
	 ...
	 * The input waveform.
	 */
	protected GLowPassFilter waveForm = null;
	...
	/**
	* Constructs the property editor for a given GLowPassFilter.
	* @param in The input GLowPassFilter.
	* @param _ins The associated instrument track.
	*/
	public LowPassFilterEditor(GLowPassFilter in , InstrumentTrack ins2 ) {
		waveForm = in;
		track = ins2;
