...
/**
 * Node representing a waveform implementing a low-pass filter on an input waveform.
 * 
 ...
 *
 */
public class GLowPassFilter extends GWaveForm implements Externalizable {
	...
	public WaveForm genWave(HashMap s) {
		...
		LowPassFilter wv = new LowPassFilter( w , intervalHalfLength , sampleLen );
		s.put(this, wv);
	...
	public void editProperties( HashMap<String,Object> context )
	{
		...
		LowPassFilterEditor editor = new LowPassFilterEditor( this , track );
