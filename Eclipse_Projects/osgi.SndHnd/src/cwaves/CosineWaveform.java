...
/**
 * Waveform for a cosine function.  Uses a lookup table to improve performance.
 * 
 * @author tgreen
 *
 */
public class CosineWaveform extends WaveForm implements Externalizable {
	...
	public CosineWaveform() {
		...
		if( !initialized )
		{
			...
			{
				nv[ count ] = Math.cos( count * SIN_INVERSE_WAVELENGTH / max );
			}
			initialized = true;
		}
	}
	...
	public GWaveForm genWave( HashMap s )
	{
		...
		GCosineWaveform wv = new GCosineWaveform();
		s.put(this, wv);
		return( wv );
	}
