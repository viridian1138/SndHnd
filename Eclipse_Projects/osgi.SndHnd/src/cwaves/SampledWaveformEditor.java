...
/**
* A property editor for editing a GSampledWaveForm node.
* <P>
* @author Thorn Green
*/
public class SampledWaveformEditor
	...
	*/
	 ...
	 * The input waveform.
	 */
	protected GSampledWaveForm waveForm = null;
	...
	/**
	 * Text field for editing the filename of the audio file to be sampled.
	 */
	...
	/**
	* Constructs the property editor for a given GSampledWaveForm.
	* @param in The input GSampledWaveForm.
	* @param _ins The associated instrument track.
	*/
	public SampledWaveformEditor(GSampledWaveForm in , InstrumentTrack ins2 ) {
		waveForm = in;
		track = ins2;
		...
		pan2.add("any", new JLabel("File Name : "));
		pan2.add("any", fileName);
		
		if( waveForm.getSoundFile() != null ) fileName.setText( "" + waveForm.getSoundFile().getAbsolutePath() );
	...
	* the edited GSampledWaveForm.
	*/
	public void actionPerformed(ActionEvent e) {
		try {
			final int core = 0;
			
			waveForm.load( new File( fileName.getText() ) );
