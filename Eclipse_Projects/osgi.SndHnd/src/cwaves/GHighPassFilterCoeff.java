...
/**
 * Node representing a non-clamped coefficient implementing a high-pass filter on an input non-clamped coefficient as the value of the input non-clamped coefficient minus the low-pass filter result.
 * 
 ...
 *
 */
public class GHighPassFilterCoeff extends GNonClampedCoefficient implements Externalizable {
	...
	public NonClampedCoefficient genCoeff(HashMap s) {
		...
		HighPassFilterCoeff wv = new HighPassFilterCoeff( w , intervalHalfLength , sampleLen );
		s.put(this, wv);
	...
	public void editProperties( HashMap<String,Object> context )
	{
		...
		HighPassFilterCoeffEditor editor = new HighPassFilterCoeffEditor( this , track );
		ProgramDirector.showPropertyEditor(editor, null,
			"High Pass Filter Coeff Properties");
	}
