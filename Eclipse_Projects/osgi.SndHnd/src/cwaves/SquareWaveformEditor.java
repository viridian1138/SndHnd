...
/**
* A property editor for editing a GSquareWaveform node.
* <P>
* @author Thorn Green
*/
public class SquareWaveformEditor
	...
	*/
	 ...
	 * The input waveform.
	 */
	protected GSquareWaveform waveForm = null;
	
	/**
	 * Text field for editing one-half the width of the negative side of the square wave.
	 */
	...
	/**
	* Constructs the property editor for a given GSquareWaveform.
	* @param in The input GSquareWaveform.
	* @param _ins The associated instrument track.
	*/
	public SquareWaveformEditor(GSquareWaveform in , InstrumentTrack _ins) {
		waveForm = in;
		ins = _ins;
