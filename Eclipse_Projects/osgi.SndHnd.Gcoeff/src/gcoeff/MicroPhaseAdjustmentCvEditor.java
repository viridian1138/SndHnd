...
/**
* A property editor for editing a GMicroPhaseAdjustmentCv node.
* <P>
* @author Thorn Green
*/
public class MicroPhaseAdjustmentCvEditor
	...
	*/
	 ...
	 */
	protected GMicroPhaseAdjustmentCv waveForm = null;
	
	/**
	 * Text field for editing the number of samples to be used to determine the phase.
	 */
	...
	/**
	* Constructs the property editor for a given GMicroPhaseAdjustmentCv.
	* @param in The input GMicroPhaseAdjustmentCv.
	*/
	public MicroPhaseAdjustmentCvEditor(GMicroPhaseAdjustmentCv in ) {
		waveForm = in;
	...
	* the edited GMicroPhaseAdjustmentCv.
	*/
