 ...
 *
 */
public class GMicroPhaseAdjustment  extends GNonClampedCoefficientMultiCore implements Externalizable {
	...
	public NonClampedCoefficientMultiCore genCoeff(HashMap s) {
		...
		NonClampedCoefficientMultiCore wv = new MicroPhaseAdjustment(w, sampleLen);
		s.put(this, wv);
	...
	{
		MicroPhaseAdjustmentEditor editor = new MicroPhaseAdjustmentEditor( this );
		ProgramDirector.showPropertyEditor(editor, null,
			"Micro Phase Adjustment Properties");
	}
