...
/**
 * A node representing a simple (not necessarily good) high-pass filter.
 * 
 ...
 *
 */
public class GHighPassFilter  extends GNonClampedCoefficientMultiCore implements Externalizable {
	...
	public NonClampedCoefficientMultiCore genCoeff(HashMap s) {
		...
		NonClampedCoefficientMultiCore wv = new HighPassFilterCoeffMultiCore(w, intervalHalfLength, sampleLen);
		s.put(this, wv);
	...
	{
		HighPassFilterEditor editor = new HighPassFilterEditor( this );
