...
/**
 * 
 * Previously experimental agent emulating the playing of string 6 (the high E string) on a Squirer guitar using Multi Xtal that has now effectively become the standard. 
 * 
 ...
 *
 */
public class ExprAgentS6 extends IntelligentAgent implements Externalizable {
...
//		note.setRoughDraftWaveform(new SineWaveform());
	...
	public void initializeInitializers()
	{
		NoteInitializer fa = new NoteInitializer( /* NoteTable.getCloseNoteDefaultScale_Key(4,
				NoteTable.STEPS_E) */ /* 196 * 2.0 */ /* 330.0 */ /* * 1.01 / 0.8344862155388472 */ 2.0 * NoteTable.getCloseNoteDefaultScale_Key(5,
						NoteTable.STEPS_C) ); // G-String One Octave Up.
		NoteInitializer fb = new NoteInitializer( /* NoteTable.getCloseNoteDefaultScale_Key(4,
				NoteTable.STEPS_F) */ /* 435 */ /* * 1.01 / 0.8344862155388472 */ 2.0 * NoteTable.getCloseNoteDefaultScale_Key(4,
						NoteTable.STEPS_F) );
		NoteInitializer fc = new NoteInitializer( /* NoteTable.getCloseNoteDefaultScale_Key(4,
				NoteTable.STEPS_E) */ /* 196 * 2.0 */ /* 330.0 */ /* * 1.01 / 0.8344862155388472 */ 2.0 * NoteTable.getCloseNoteDefaultScale_Key(4,
						NoteTable.STEPS_B) ); // G-String One Octave Up.
		NoteInitializer fd = new NoteInitializer( /* NoteTable.getCloseNoteDefaultScale_Key(4,
				NoteTable.STEPS_F) */ /* 435 */ /* * 1.01 / 0.8344862155388472 */ 2.0 * NoteTable.getCloseNoteDefaultScale_Key(4,
						NoteTable.STEPS_E) );
		
		NoteInitializer fk = new NoteInitializer( /* NoteTable.getCloseNoteDefaultScale_Key(4,
				NoteTable.STEPS_F) */ /* 435 */ /* * 1.01 / 0.8344862155388472 */ NoteTable.getCloseNoteDefaultScale_Key(4,
						NoteTable.STEPS_E) );
		
		NoteInitializer fk2 = new NoteInitializer( /* NoteTable.getCloseNoteDefaultScale_Key(4,
				NoteTable.STEPS_F) */ /* 435 */ /* * 1.01 / 0.8344862155388472 */ NoteTable.getCloseNoteDefaultScale_Key(4,
						NoteTable.STEPS_F) );
		...
		noteInitializers.add( fd );
		noteInitializers.add( fc );
		noteInitializers.add( fc );
		noteInitializers.add( fd );
		noteInitializers.add( fc );
		noteInitializers.add( fc );
		...
		noteInitializers.add( fk );
		noteInitializers.add( fk2 );
	}
