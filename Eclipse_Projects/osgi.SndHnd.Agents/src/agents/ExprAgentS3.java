...
/**
 * 
 * Previously experimental agent emulating the playing of string 3 (the D string) on a Squirer guitar using Multi Xtal that has now effectively become the standard. 
 * 
 ...
 *
 */
public class ExprAgentS3 extends IntelligentAgent implements Externalizable {
