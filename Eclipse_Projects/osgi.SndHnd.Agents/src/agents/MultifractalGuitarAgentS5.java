...
/**
 * 
 * Agent using a multifractal to emulate the playing of string 5 (the B string) on an electric guitar (with perhaps a somewhat more acoustic guitar timbre).
 * 
 ...
 *
 */
public class MultifractalGuitarAgentS5 extends IntelligentAgent implements Externalizable {
...
//		note.setRoughDraftWaveform(new SineWaveform());
	 ...
	 */
	public MultifractalGuitarAgentS5() {
		super();
