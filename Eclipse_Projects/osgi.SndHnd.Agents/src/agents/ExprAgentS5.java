...
/**
 * 
 * Previously experimental agent emulating the playing of string 5 (the B string) on a Squirer guitar using Multi Xtal that has now effectively become the standard. 
 * 
 ...
 *
 */
public class ExprAgentS5 extends IntelligentAgent implements Externalizable {
	...
	public WaveForm genWaveQB()
	{
		...
		PhaseDistortionPacket pdcxf2 = new PhaseDistortionPacket(
				new SineWaveform(), 1.0,  0.08814035087719298 );
		...
		coefficientCoefficients.add( new ConstantNonClampedCoefficient( 500.0 * ( 9489.999025306333 / 9.402413182163193E-4 ) / maxDivisor ));
		parameterCoefficients.add( new ConstantNonClampedCoefficient( 1.0 ));
		//coefficients.add( invg2 );
		//coefficientCoefficients.add( new ConstantNonClampedCoefficient( 1.0 * ( 8446.001035972222 / 0.003536592309073662 ) / maxDivisor ));
		//parameterCoefficients.add( new ConstantNonClampedCoefficient( 1.0 ));
		
		
		WaveForm wave3 = MultiXtalBuilder.builtMultiXtalS5B();
	...
	{
		double m2 = 1.0;
		double maxDivisor = 13.49;
		ArrayList<NonClampedCoefficient> coefficients = new ArrayList<NonClampedCoefficient>();
		ArrayList<NonClampedCoefficient> coefficientCoefficients = new ArrayList<NonClampedCoefficient>();
		ArrayList<NonClampedCoefficient> parameterCoefficients = new ArrayList<NonClampedCoefficient>();
		PhaseDistortionPacket pdcxf2 = new PhaseDistortionPacket(
				new SineWaveform(), 1.0,  0.15581954887218044 );
		//PhaseDistortionPacket pdcxg2 = new PhaseDistortionPacket(
		//		new SineWaveform(), 1.0,  0.06059649122807017 );
		PhaseDistortionPacket[] pdccxf2 = { pdcxf2 };
		//PhaseDistortionPacket[] pdccxg2 = { pdcxg2 };
		WaveForm invf2 = new ArithGntWaveform( new Inverter(pdccxf2) , 5 );
		//WaveForm invg2 = new ArithGntWaveform( new Inverter(pdccxg2) , 4 );
		coefficients.add( invf2 );
		coefficientCoefficients.add( new ConstantNonClampedCoefficient( 3E+25 * ( 7.0627031760566885E-12 / 1.1226424094071491E-5 ) / maxDivisor ));
		parameterCoefficients.add( new ConstantNonClampedCoefficient( 1.0 ));
		//coefficients.add( invg2 );
		...
		WaveForm wave3 = MultiXtalBuilder.builtMultiXtalS5A();
		wave3 = new AdditiveWaveForm( wave3 , new ConstantNonClampedCoefficient( 1.0 / maxDivisor ) ,
				coefficients , coefficientCoefficients , parameterCoefficients );
