 ...
 * Plays at rough the pitch of String 2 (the A string) of a guitar.
 * 
 ...
 *
 */
public class HighFreqGuitarPlayingAgent extends IntelligentAgent implements Externalizable {
	 ...
	 */
	public HighFreqGuitarPlayingAgent() {
		super();
		
		PhaseDistortionPacket pdcxa = new PhaseDistortionPacket(
				new SineWaveform(), 1.0, /* 0.2 */0.1);
		PhaseDistortionPacket pdcxb = new PhaseDistortionPacket(
				new SineWaveform(), 1.0, /* 0.2 */0.4);
