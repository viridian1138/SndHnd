...
import waves.HarmonicDistortionWaveForm;
...
/**
 * 
 * Agent emulating the playing of string 2 (the A string) on a Bronco bass guitar. 
 * 
 ...
 *
 */
public class BassLoExprAgentS2 extends IntelligentAgent implements Externalizable {
	...
	public WaveForm genWaveQB()
	{
		...
		PhaseDistortionPacket pdcxf2 = new PhaseDistortionPacket(
				new SineWaveform(), 1.0,  0.09837092731829573 );
		PhaseDistortionPacket pdcxg2 = new PhaseDistortionPacket(
				new SineWaveform(), 1.0,  0.04367669172932331 );
		...
		coefficientCoefficients.add( new ConstantNonClampedCoefficient( 2000.0 * ( -185473.38749676174 / 0.004760209533525957 ) / maxDivisor ));
		parameterCoefficients.add( new ConstantNonClampedCoefficient( 1.0 ));
		coefficients.add( invg2 );
		coefficientCoefficients.add( new ConstantNonClampedCoefficient( 2000.0 * ( -108481.66665514397 / 0.004760209533525957 ) / maxDivisor ));
		parameterCoefficients.add( new ConstantNonClampedCoefficient( 1.0 ));
		
		
		WaveForm wave3 = MultiXtalBuilder.builtMultiXtalS4B2();
		...
		System.out.println( "Got New Built17B!!!" );
	...
	{	
		double m2 = 1.0;
		double maxDivisor = 5.21;
		ArrayList<NonClampedCoefficient> coefficients = new ArrayList<NonClampedCoefficient>();
		ArrayList<NonClampedCoefficient> coefficientCoefficients = new ArrayList<NonClampedCoefficient>();
		ArrayList<NonClampedCoefficient> parameterCoefficients = new ArrayList<NonClampedCoefficient>();
		PhaseDistortionPacket pdcxf2 = new PhaseDistortionPacket(
				new SineWaveform(), 1.0,  0.04485714285714285 );
		PhaseDistortionPacket pdcxg2 = new PhaseDistortionPacket(
				new SineWaveform(), 1.0,  0.009837092731829573 );
		PhaseDistortionPacket[] pdccxf2 = { pdcxf2 };
		PhaseDistortionPacket[] pdccxg2 = { pdcxg2 };
		WaveForm invf2 = new ArithGntWaveform( new Inverter(pdccxf2) , 4 );
		WaveForm invg2 = new ArithGntWaveform( new Inverter(pdccxg2) , 3 );
		coefficients.add( invf2 );
		coefficientCoefficients.add( new ConstantNonClampedCoefficient( 4000.0 * ( -203484.40001204034 / -0.00391057417233763 ) / maxDivisor ));
		parameterCoefficients.add( new ConstantNonClampedCoefficient( 1.0 ));
		coefficients.add( invg2 );
		coefficientCoefficients.add( new ConstantNonClampedCoefficient( 4000.0 * ( 9539.33320230242 / -0.00391057417233763 ) / maxDivisor ));
		parameterCoefficients.add( new ConstantNonClampedCoefficient( 1.0 ));
		
		
		
		WaveForm wave3 = MultiXtalBuilder.builtMultiXtalS4A2();
		wave3 = new AdditiveWaveForm( wave3 , new ConstantNonClampedCoefficient( 1.0 / maxDivisor ) ,
				coefficients , coefficientCoefficients , parameterCoefficients );
		
		wave3 = new HarmonicDistortionWaveForm( wave3 , 0.5 , -1 , 0.03 , 10 , false , true , false );
		
		System.out.println( "Got New Built8A!!!" );
