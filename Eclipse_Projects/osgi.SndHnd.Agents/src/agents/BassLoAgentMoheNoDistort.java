...
/**
 * 
 * Similar to BassLoAgentMohe but without any built-in distortion of the tone.
 * 
 ...
 *
 */
public class BassLoAgentMoheNoDistort extends IntelligentAgent implements Externalizable {
	 ...
	 */
	public BassLoAgentMoheNoDistort() {
		super();
	...
	public void initializeInitializers()
	{
		...
		// noteInitializers.add( /* fb */ fa );
		
		
//		 Octaves alternate 1,1,1,2
//		double lv = Math.pow( NoteTable.getCloseNoteDefaultScale_Key(1,
//				NoteTable.STEPS_A) * NoteTable.getCloseNoteDefaultScale_Key(1,
//						NoteTable.STEPS_A) * NoteTable.getCloseNoteDefaultScale_Key(1,
//								NoteTable.STEPS_A_SHARP) , 1.0 / 3.0 );
