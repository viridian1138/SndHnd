...
/**
 * 
 * Percussion agent to emulate the playing of an instrument similar to a snare drum.
 * 
 * Note: like (some) real percussive instruments, SnarePercussionAgent plays on a particular key.  That is to say, the key of the percussion could match/mismatch the key of the rest of the song.
 ...
 *
 */
public class SnarePercussionAgent extends IntelligentAgent implements Externalizable {
