...
/**
 * 
 * Agent emulating the expected timbre for playing the string on a five-string bass guitar that is below string 1 on a four-string bass guitar (the B string on a five-string bass) using a multifractal.
 * 
 * Timbre is tighter and punchier, but also more synthetic and less rich, than BassLoExprAgentS0.
 * 
 ...
 *
 */
public class MultifractalBassLoGuitarAgentS0 extends IntelligentAgent implements Externalizable {
...
/*
	...
	*/
	 ...
	 */
	public MultifractalBassLoGuitarAgentS0() {
		super();
		
		TriangleWaveform pdcxa = new TriangleWaveform( 0.25 );
		SawtoothWaveform pdcxb = new SawtoothWaveform();
		
		FrequencyModulationWaveForm fpdcxa = new FrequencyModulationWaveForm( pdcxa , new ConstantNonClampedCoefficient( 4.0 )  );
		FrequencyModulationWaveForm fpdcxb = new FrequencyModulationWaveForm( pdcxb , new ConstantNonClampedCoefficient( 4.0 )  );
		
		WaveForm inva = new MultifractalWaveForm( fpdcxa , 0.3 , 0.5 , 3 , 0.3  );
		WaveForm invb = new MultifractalWaveForm( fpdcxb , 0.3 , 10.0 , 3 , 0.3  );
