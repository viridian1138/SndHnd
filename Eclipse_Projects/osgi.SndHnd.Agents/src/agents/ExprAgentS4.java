...
/**
 * 
 * Previously experimental agent emulating the playing of string 4 (the G string) on a Squirer guitar using Multi Xtal that has now effectively become the standard. 
 * 
 * Note: for this agent the apparent audible pitch of the generated note is one octave down from the actual oscillatory frequency of the waveform.
 * 
 ...
 *
 */
public class ExprAgentS4 extends IntelligentAgent implements Externalizable {
