...
/**
 * 
 * Agent emulating the playing of a guitar slightly above string 2 (the A string) created for use in a song about the Independent Lens feature "How Is Your Fish Today?" that was never finished. 
 * 
 * Uses the same general Inverter timbre generation as SquirerAgentS1.
 * 
 ...
 *
 */
public class MidAgentMohe extends IntelligentAgent implements Externalizable {
