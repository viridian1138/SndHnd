...
/**
 * 
 * Previously experimental agent emulating the playing of string 1 (the low E string) on a Squirer guitar using Multi Xtal that has now effectively become the standard. 
 * 
 ...
 *
 */
public class ExprAgentS1 extends IntelligentAgent implements Externalizable {
	...
	public WaveForm genWaveQA()
	{
		...
		WaveForm wave3 = MultiXtalS1.builtMultiXtalS1A2();
	...
	public WaveForm genWaveQB()
	{
		...
		PhaseDistortionPacket pdcxg2 = new PhaseDistortionPacket(
				new SineWaveform(), 1.0,  0.12434085213032581 );
		PhaseDistortionPacket pdcxh2 = new PhaseDistortionPacket(
				new SineWaveform(), 1.0,  0.002360902255639098 );
		PhaseDistortionPacket pdcxi2 = new PhaseDistortionPacket(
				new SineWaveform(), 1.0,  0.12394736842105264 );
		PhaseDistortionPacket[] pdccxf2 = { pdcxf2 };
		PhaseDistortionPacket[] pdccxg2 = { pdcxg2 };
		PhaseDistortionPacket[] pdccxh2 = { pdcxh2 };
		...
		WaveForm invg2 = new ArithGntWaveform( new Inverter(pdccxg2) , 4 );
		WaveForm invh2 = new ArithGntWaveform( new Inverter(pdccxh2) , 2 );
		WaveForm invi2 = new ArithGntWaveform( new Inverter(pdccxi2) , 4 );
		final double multa = 0.25 / 2E-4;
		coefficients.add( invf2 );
		coefficientCoefficients.add( new ConstantNonClampedCoefficient( multa * ( 5690.033999103175 / 0.0015431599884301215 ) / maxDivisor ));
		parameterCoefficients.add( new ConstantNonClampedCoefficient( 1.0 ));
		coefficients.add( invg2 );
		coefficientCoefficients.add( new ConstantNonClampedCoefficient( multa * ( 2501.7300509939255 / 0.0015431599884301215 ) / maxDivisor ));
		parameterCoefficients.add( new ConstantNonClampedCoefficient( 1.0 ));
		coefficients.add( invh2 );
		coefficientCoefficients.add( new ConstantNonClampedCoefficient( multa * ( -2797.799798943986 / 0.0015431599884301215 ) / maxDivisor ));
		parameterCoefficients.add( new ConstantNonClampedCoefficient( 1.0 ));
		coefficients.add( invi2 );
		coefficientCoefficients.add( new ConstantNonClampedCoefficient( multa * ( ( 7351.999965995648 + 7347.9999659771365 ) / 0.0015431599884301215 ) / maxDivisor ));
		parameterCoefficients.add( new ConstantNonClampedCoefficient( 1.0 ));
		
		
		
		WaveForm wave3 = MultiXtalS1.builtMultiXtalS1B2();
		wave3 = new AdditiveWaveForm( wave3 , new ConstantNonClampedCoefficient( 1.0 / maxDivisor ) ,
				coefficients , coefficientCoefficients , parameterCoefficients );
