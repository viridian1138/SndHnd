...
import waves.MultiXtalBassShack;
...
/**
 * 
 * Agent emulating the playing of a shack guitar at roughly the same pitch as string 2 (the A string) on a bass guitar. 
 * 
 ...
 *
 */
public class BassShackGuitarAgent extends IntelligentAgent implements Externalizable {
	...
	public WaveForm genWaveQB()
	{
		...
		PhaseDistortionPacket pdcxf2 = new PhaseDistortionPacket(
				new SineWaveform(), 1.0,  0.10899498746867169 );
		PhaseDistortionPacket pdcxg2 = new PhaseDistortionPacket(
				new SineWaveform(), 1.0,  0.05862907268170426 );
		...
		coefficientCoefficients.add( new ConstantNonClampedCoefficient( 1000000.0 * ( -60402.219685432094 / 1.0 ) / maxDivisor ));
		parameterCoefficients.add( new ConstantNonClampedCoefficient( 1.0 ));
		coefficients.add( invg2 );
		coefficientCoefficients.add( new ConstantNonClampedCoefficient( 1000000.0 * ( 28360.948793473442 / 1.0 ) / maxDivisor ));
		parameterCoefficients.add( new ConstantNonClampedCoefficient( 1.0 ));
		coefficients.add( invh2 );
		coefficientCoefficients.add( new ConstantNonClampedCoefficient( 1000000.0 * ( 42302.585023699285 / 1.0 ) / maxDivisor ));
		parameterCoefficients.add( new ConstantNonClampedCoefficient( 1.0 ));
		
		
		WaveForm wave3 = MultiXtalBassShack.builtMultiXtalBassShackB2( );
		...
		System.out.println( "Got New Built177E!!!" );
	...
	{
		double maxDivisor = 5.09;
		ArrayList<NonClampedCoefficient> coefficients = new ArrayList<NonClampedCoefficient>();
		ArrayList<NonClampedCoefficient> coefficientCoefficients = new ArrayList<NonClampedCoefficient>();
		ArrayList<NonClampedCoefficient> parameterCoefficients = new ArrayList<NonClampedCoefficient>();
		PhaseDistortionPacket pdcxf2 = new PhaseDistortionPacket(
				new SineWaveform(), 1.0,  0.012591478696741853 );
		PhaseDistortionPacket pdcxg2 = new PhaseDistortionPacket(
				new SineWaveform(), 1.0,  0.09089473684210526 );
		PhaseDistortionPacket[] pdccxf2 = { pdcxf2 };
		PhaseDistortionPacket[] pdccxg2 = { pdcxg2 };
		WaveForm invf2 = new ArithGntWaveform( new Inverter(pdccxf2) , 3 );
		coefficients.add( invf2 );
		coefficientCoefficients.add( new ConstantNonClampedCoefficient( 500000.0 * ( 67804.71425356239 ) / maxDivisor ));
		parameterCoefficients.add( new ConstantNonClampedCoefficient( 1.0 ));
		WaveForm invg2 = new ArithGntWaveform( new Inverter(pdccxg2) , 4 );
		coefficients.add( invg2 );
		coefficientCoefficients.add( new ConstantNonClampedCoefficient( 500000.0 * ( -29541.600366288352 ) / maxDivisor ));
		parameterCoefficients.add( new ConstantNonClampedCoefficient( 1.0 ));
		
		
		// 0.0
		WaveForm wave3 = MultiXtalBassShack.builtMultiXtalBassShackA2( );
		wave3 = new AdditiveWaveForm( wave3 , new ConstantNonClampedCoefficient( 1.0 / maxDivisor ) ,
				coefficients , coefficientCoefficients , parameterCoefficients );
		System.out.println( "Got New Built7BB1!!!" );
	 ...
	 */
	public BassShackGuitarAgent() {
		super();
		
		WaveForm inva = genWaveA();
		WaveForm invb = genWaveB();
