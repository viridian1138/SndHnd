...
/**
 * 
 * Agent using a multifractal to emulate the playing of string 4 (the G string) on an electric guitar (with perhaps a somewhat more acoustic guitar timbre).
 * 
 ...
 *
 */
public class MultifractalGuitarAgentS4 extends IntelligentAgent implements Externalizable {
...
//		note.setRoughDraftWaveform(new SineWaveform());
	 ...
	 */
	public MultifractalGuitarAgentS4() {
		super();
