...
/**
 * 
 * Agent emulating the expected timbre for playing an extra A string immediately below the B string on a five-string bass using a multifractal.
 * 
 ...
 *
 */
public class MultifractalBassLoGuitarAgentS_neg1 extends IntelligentAgent implements Externalizable {
	 ...
	 */
	protected double minDecayTimeBeats = /* 6.0 */ 4.0;
	 ...
	 */
	protected double cutoffTimeWaves = 0.13 /* 2.5 */;

	/**
	 * The duration of the initial attack of a note in waves.
	 */
	protected double attackTimeWaves = 0.75 /* 1.5 */  /* 8.75 */  /* 3.0 */  /* 5.0 */;
	 ...
	 */
	public MultifractalBassLoGuitarAgentS_neg1() {
		super();
		
		// TriangleWaveform pdcxa = new TriangleWaveform( 0.25 );
		SawtoothWaveform pdcxa = new SawtoothWaveform();
		...
		WaveForm invb = new MultifractalWaveForm( fpdcxb , 0.3 , 0.5 , 3 , 0.3  );
	...
	public void initializeInitializers()
	{
		NoteInitializer fa = new NoteInitializer( NoteTable.getCloseNoteDefaultScale_Key(0,
				NoteTable.STEPS_A) );
		NoteInitializer fb = new NoteInitializer( NoteTable.getCloseNoteDefaultScale_Key(0,
				NoteTable.STEPS_B) );
