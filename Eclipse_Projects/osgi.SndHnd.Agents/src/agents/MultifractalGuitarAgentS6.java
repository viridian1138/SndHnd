...
/**
 * 
 * Agent using a multifractal to emulate the playing of string 6 (the high E string) on an electric guitar (with perhaps a somewhat more acoustic guitar timbre).
 * 
 ...
 *
 */
public class MultifractalGuitarAgentS6 extends IntelligentAgent implements Externalizable {
...
//		note.setRoughDraftWaveform(new SineWaveform());
	 ...
	 */
	public MultifractalGuitarAgentS6() {
		super();
