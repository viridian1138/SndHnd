...
/**
 * 
 * Agent generating a percussive effect from a very low frequency guitar-like timbre.
 * 
 * Note: like (some) real percussive instruments, PercussiveAgentGuitarLike plays on a particular key.  That is to say, the key of the percussion could match/mismatch the key of the rest of the song.
 * 
 ...
 *
 */
public class PercussiveAgentGuitarLike extends IntelligentAgent implements Externalizable {
...
//		note.setRoughDraftWaveform(new SineWaveform());
	 ...
	 */
	public PercussiveAgentGuitarLike() {
		super();
