...
/**
 * 
 * Agent emulating the expected timbre for playing the string on a five-string bass guitar that is below string 1 on a Bronco bass guitar (the B string on a five-string bass).
 * 
 ...
 *
 */
public class BassLoExprAgentS0 extends IntelligentAgent implements Externalizable {
...
//		note.setRoughDraftWaveform(new SineWaveform());
	...
	public static GWaveForm buildBassWaveFormB(GWaveForm wave0) {
		...
		bezAC.getInterpolationPoints().add(new InterpolationPoint(0.0, -1*0.15+strt));
		bezAC.getInterpolationPoints().add(new InterpolationPoint(2.0, -0.75*0.15+strt));
		bezAC.getInterpolationPoints().add(new InterpolationPoint(4.0, -0.25*0.15+strt));
		bezAC.getInterpolationPoints().add(new InterpolationPoint(6.0, -0.125*0.15+strt));
		bezAC.getInterpolationPoints().add(new InterpolationPoint(8.0, -0.0625*0.15+strt));
		bezAC.getInterpolationPoints().add(new InterpolationPoint(10.0, 0.0+strt));
		bezAC.getInterpolationPoints().add(new InterpolationPoint(12.0, 0.0+strt));
		bezAC.updateAll();
...
/*
	...
	*/
	...
	{
		NoteInitializer fa = new NoteInitializer( NoteTable.getCloseNoteDefaultScale_Key(0,
				NoteTable.STEPS_B) );
