...
/**
 * 
 * Agent emulating the playing of string 1 (the low E string) on a Squirer guitar using prettymuch only inverters for the timbre.  Timbre is similar to ExprAgentS1, but is more mundane and less rich.
 * 
 ...
 *
 */
public class ZSoundAgentS1Dry extends IntelligentAgent implements Externalizable {
	...
	protected NonClampedCoefficient buildPrimaryCoeff() {
		...
		bezAC.getInterpolationPoints().add(new InterpolationPoint(18.0, dvalPrim(0.8608))); // 0.86
	...
	public WaveForm genWaveQA()
	{
		...
		PhaseDistortionPacket pdcxf2 = new PhaseDistortionPacket(
				new SineWaveform(), 1.0,  0.010624060150375939 );
		PhaseDistortionPacket pdcxg2 = new PhaseDistortionPacket(
				new SineWaveform(), 1.0,  0.3006691729323308 );
		PhaseDistortionPacket pdcxh2 = new PhaseDistortionPacket(
				new SineWaveform(), 1.0,  0.04131578947368421 );
		...
		coefficientCoefficients.add( new ConstantNonClampedCoefficient( 2.0 * 0.0000063 * ( 21250.34999814709 / -0.005675834843371158 ) / maxDivisor ));
		parameterCoefficients.add( new ConstantNonClampedCoefficient( 1.0 ));
		coefficients.add( invg2 );
		coefficientCoefficients.add( new ConstantNonClampedCoefficient( 2.0 * 0.000063 * ( -1.2789474424449762E-14 / -0.005675834843371158 ) / maxDivisor ));
		parameterCoefficients.add( new ConstantNonClampedCoefficient( 1.0 ));
		coefficients.add( invh2 );
		coefficientCoefficients.add( new ConstantNonClampedCoefficient( 2.0 * 0.0000063 * ( 83275.99985289924 / -0.005675834843371158 ) / maxDivisor ));
		parameterCoefficients.add( new ConstantNonClampedCoefficient( 1.0 ));
		
		
		
		WaveForm wave3 = DryXtalS1.builtDryXtalS1A2();
		...
		// wave3 = new HarmonicDistortionWaveForm( wave3 , 0.5 , -1 , 0.05 , 10 , false , true , false );
		
		System.out.println( "Got New Built9A!!!" );
	...
	{
		double m2 = 1.0;
		double maxDivisor = 103.3;
		ArrayList<NonClampedCoefficient> coefficients = new ArrayList<NonClampedCoefficient>();
		ArrayList<NonClampedCoefficient> coefficientCoefficients = new ArrayList<NonClampedCoefficient>();
		ArrayList<NonClampedCoefficient> parameterCoefficients = new ArrayList<NonClampedCoefficient>();
		PhaseDistortionPacket pdcxf2 = new PhaseDistortionPacket(
				new SineWaveform(), 1.0,  0.08892731829573934 );
		PhaseDistortionPacket pdcxg2 = new PhaseDistortionPacket(
				new SineWaveform(), 1.0,  0.14480200501253132 );
		PhaseDistortionPacket pdcxh2 = new PhaseDistortionPacket(
				new SineWaveform(), 1.0,  0.06571177944862155 );
		PhaseDistortionPacket pdcxi2 = new PhaseDistortionPacket(
				new SineWaveform(), 1.0,  0.05548120300751879 );
		PhaseDistortionPacket pdcxj2 = new PhaseDistortionPacket(
				new SineWaveform(), 1.0,  0.11607769423558897 );
		PhaseDistortionPacket pdcxk2 = new PhaseDistortionPacket(
				new SineWaveform(), 1.0,  0.07987719298245614 );
		PhaseDistortionPacket pdcxl2 = new PhaseDistortionPacket(
				new SineWaveform(), 1.0,  0.06138345864661654 );
		PhaseDistortionPacket[] pdccxf2 = { pdcxf2 };
		PhaseDistortionPacket[] pdccxg2 = { pdcxg2 };
		PhaseDistortionPacket[] pdccxh2 = { pdcxh2 };
		PhaseDistortionPacket[] pdccxi2 = { pdcxi2 };
		PhaseDistortionPacket[] pdccxj2 = { pdcxj2 };
		PhaseDistortionPacket[] pdccxk2 = { pdcxk2 };
		PhaseDistortionPacket[] pdccxl2 = { pdcxl2 };
		WaveForm invf2 = new ArithGntWaveform( new Inverter(pdccxf2) , 4 );
		WaveForm invg2 = new ArithGntWaveform( new Inverter(pdccxg2) , 4 );
		WaveForm invh2 = new ArithGntWaveform( new Inverter(pdccxh2) , 4 );
		WaveForm invi2 = new ArithGntWaveform( new Inverter(pdccxi2) , 4 );
		WaveForm invj2 = new ArithGntWaveform( new Inverter(pdccxj2) , 4 );
		WaveForm invk2 = new ArithGntWaveform( new Inverter(pdccxk2) , 4 );
		WaveForm invl2 = new ArithGntWaveform( new Inverter(pdccxl2) , 4 );
		final double multa = 2.0 * 370.0 * 5.0;
		coefficients.add( invf2 );
		coefficientCoefficients.add( new ConstantNonClampedCoefficient( multa * ( -1808.9095027156836 / 1.7343558568844408E-4 ) / maxDivisor ));
		parameterCoefficients.add( new ConstantNonClampedCoefficient( 1.0 ));
		coefficients.add( invg2 );
		coefficientCoefficients.add( new ConstantNonClampedCoefficient( multa * ( 2951.449979087726 / 1.7343558568844408E-4 ) / maxDivisor ));
		parameterCoefficients.add( new ConstantNonClampedCoefficient( 1.0 ));
		coefficients.add( invh2 );
		coefficientCoefficients.add( new ConstantNonClampedCoefficient( multa * ( 7192.68124543433 / 1.7343558568844408E-4 ) / maxDivisor ));
		parameterCoefficients.add( new ConstantNonClampedCoefficient( 1.0 ));
		coefficients.add( invi2 );
		coefficientCoefficients.add( new ConstantNonClampedCoefficient( multa * ( 5009.373933447272 / 1.7343558568844408E-4 ) / maxDivisor ));
		parameterCoefficients.add( new ConstantNonClampedCoefficient( 1.0 ));
		coefficients.add( invj2 );
		coefficientCoefficients.add( new ConstantNonClampedCoefficient( multa * ( 8866.671965579206 / 1.7343558568844408E-4 ) / maxDivisor ));
		parameterCoefficients.add( new ConstantNonClampedCoefficient( 1.0 ));
		coefficients.add( invk2 );
		coefficientCoefficients.add( new ConstantNonClampedCoefficient( multa * ( 8445.5999608524 / 1.7343558568844408E-4 ) / maxDivisor ));
		parameterCoefficients.add( new ConstantNonClampedCoefficient( 1.0 ));
		coefficients.add( invl2 );
		coefficientCoefficients.add( new ConstantNonClampedCoefficient( multa * ( 6418.999493708766 / 1.7343558568844408E-4 ) / maxDivisor ));
		parameterCoefficients.add( new ConstantNonClampedCoefficient( 1.0 ));
		
		
		
		WaveForm wave3 = DryXtalS1.builtDryXtalS1B2();
		wave3 = new AdditiveWaveForm( wave3 , new ConstantNonClampedCoefficient( 1.0 / maxDivisor ) ,
				coefficients , coefficientCoefficients , parameterCoefficients );
