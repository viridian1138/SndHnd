...
/**
 * 
 * Agent that uses a multifractal to emulate the playing of a synthesizer with a metallic timbre.
 * 
 ...
 *
 */
public class MultifractalMetallicInstrumentAgent extends IntelligentAgent implements Externalizable {
...
//		note.setRoughDraftWaveform(new SineWaveform());
	 ...
	 */
	public MultifractalMetallicInstrumentAgent() {
		super();
		...
		FrequencyModulationWaveForm fpdcxa = new FrequencyModulationWaveForm( noiseGrpA.genWave( new HashMap() ) , new ConstantNonClampedCoefficient( 4.0 )  );
		FrequencyModulationWaveForm fpdcxb = new FrequencyModulationWaveForm( noiseGrpB.genWave( new HashMap() ) , new ConstantNonClampedCoefficient( 4.0 )  );
		
		WaveForm inva = fpdcxa;
		WaveForm invb = fpdcxb;
